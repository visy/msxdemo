...
; This file was generated Thu Feb 15 02:14:05 2018
;--------------------------------------------------------
	.module demo
	.optsdcc -mz80
...
;demo.c:307: int linenum = 0;
	...
	ld	iy,#_linenum
	ld	1 (iy),#0x00
;demo.c:361: static int xo = 0;
	ld	iy,#_xo
	ld	0 (iy),#0x00
	ld	iy,#_xo
	ld	1 (iy),#0x00
;demo.c:362: static int yo = 0;
	ld	iy,#_yo
	ld	0 (iy),#0x00
	ld	iy,#_yo
	ld	1 (iy),#0x00
;demo.c:363: static int po = 0;
	ld	iy,#_po
	ld	0 (iy),#0x00
	ld	iy,#_po
	ld	1 (iy),#0x00
;demo.c:364: static int fffaaa = 0;
	ld	iy,#_fffaaa
	ld	0 (iy),#0x00
	ld	iy,#_fffaaa
	ld	1 (iy),#0x00
...
_do_animplay:
	...
	add	hl,sp
	ld	sp,hl
;demo.c:371: for (y = 0; y < 106; y+=1) {
	ld	-1 (ix),#0x00
00107$:
	ld	a,-1 (ix)
	sub	a,#0x6A
	jp	NC,00110$
;demo.c:372: cmd.source_x = xo;
	ld	hl,#0x0004
	add	hl,sp
	ex	de,hl
	ld	bc,(_xo)
	...
	inc	hl
	ld	(hl),b
;demo.c:373: cmd.source_y = 256+po+yo+(y>>1);
	ld	hl,#0x0004
	add	hl,sp
	ld	c,l
	ld	b,h
	...
	inc	hl
	ld	(hl),d
;demo.c:374: cmd.dest_x = 0;
	ld	hl,#0x0004
	add	hl,bc
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:375: cmd.dest_y = (y<<1);
	ld	hl,#0x0006
	add	hl,bc
	ld	-20 (ix),l
	ld	-19 (ix),h
	...
	inc	hl
	ld	(hl),d
;demo.c:376: cmd.size_x = 128;
	ld	hl,#0x0008
	add	hl,bc
	ld	(hl),#0x80
	inc	hl
	ld	(hl),#0x00
;demo.c:377: cmd.size_y = 1;
	ld	hl,#0x000A
	add	hl,bc
	ld	(hl),#0x01
	inc	hl
	ld	(hl),#0x00
;demo.c:378: cmd.data = 0;
	ld	hl,#0x000C
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:379: cmd.argument = 0x00;
	ld	hl,#0x000D
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:380: cmd.command = 0xD0;
	ld	hl,#0x000E
	add	hl,bc
	ex	de,hl
	ld	a,#0xD0
	ld	(de),a
;demo.c:381: vdp_copier(&cmd);
	push	bc
	call	_vdp_copier
	pop	af
;demo.c:371: for (y = 0; y < 106; y+=1) {
	...
	jp	00107$
00110$:
;demo.c:384: for (y = 0; y < 106; y+=1) {
	ld	-1 (ix),#0x00
00111$:
	ld	a,-1 (ix)
	sub	a,#0x6A
	jp	NC,00114$
;demo.c:385: cmd.source_x = xo;
	ld	hl,#0x0004
	add	hl,sp
	ex	de,hl
	ld	bc,(_xo)
	...
	inc	hl
	ld	(hl),b
;demo.c:386: cmd.source_y = 256+po+yo+(y>>1);
	ld	hl,#0x0004
	add	hl,sp
	ld	c,l
	ld	b,h
	...
	inc	hl
	ld	(hl),d
;demo.c:387: cmd.dest_x = 128;
	ld	hl,#0x0004
	add	hl,bc
	ld	(hl),#0x80
	inc	hl
	ld	(hl),#0x00
;demo.c:388: cmd.dest_y = (y<<1);
	ld	hl,#0x0006
	add	hl,bc
	ld	-20 (ix),l
	ld	-19 (ix),h
	...
	inc	hl
	ld	(hl),d
;demo.c:389: cmd.size_x = 128;
	ld	hl,#0x0008
	add	hl,bc
	ld	(hl),#0x80
	inc	hl
	ld	(hl),#0x00
;demo.c:390: cmd.size_y = 1;
	ld	hl,#0x000A
	add	hl,bc
	ld	(hl),#0x01
	inc	hl
	ld	(hl),#0x00
;demo.c:391: cmd.data = 0;
	ld	hl,#0x000C
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:392: cmd.argument = 0x00;
	ld	hl,#0x000D
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:393: cmd.command = 0xd2; // logical vram to vram, xor
	ld	hl,#0x000E
	add	hl,bc
	ex	de,hl
	ld	a,#0xD2
	ld	(de),a
;demo.c:394: vdp_copier(&cmd);
	push	bc
	call	_vdp_copier
	pop	af
;demo.c:384: for (y = 0; y < 106; y+=1) {
...
;demo.c:401: yo+=53;
	...
	inc	hl
	ld	(hl),a
;demo.c:402: if (yo >= 212) { yo = 0; po+=256; }
	ld	a,(#_yo+0)
	sub	a,#0xD4
	ld	a,(#_yo+1)
	sbc	a,#0x00
...
;demo.c:404: po = 0;
	...
	ld	(hl), #0x00
00106$:
;demo.c:409: msx2_palette(15,3+sintab[fffaaa & 255]>>5,3,4);
	ld	hl,#_fffaaa + 0
	ld	c,(hl)
	ld	b,#0x00
	ld	hl,#_sintab
	...
	pop	af
	pop	af
;demo.c:410: msx2_palette(3,2+sintab[fffaaa & 255]>>5,0,0);
	ld	hl,#_fffaaa + 0
	ld	c,(hl)
	ld	b,#0x00
	ld	hl,#_sintab
...
00132$:
	...
	ret
_do_animplay_end::
;demo.c:420: void main() {
;	---------------------------------
; Function main
; ---------------------------------
_main_start::
_main:
;demo.c:421: unsigned char quit=0;
	ld	c,#0x00
;demo.c:422: int modes = 128; // interlace bit on
	ld	de,#0x0080
;demo.c:425: spindown();
	push	bc
	push	de
...
;demo.c:440: puts("music init...");
	...
	pop	de
	pop	bc
;demo.c:442: PLY_SongPtr = (char *)0x0103;
...
;demo.c:446: if(isvdp2())
	...
	or	a,a
	jr	Z,00102$
;demo.c:448: modes+=2; // pal
	ld	de,#0x0082
00102$:
;demo.c:452: vdp_set_screen5();
	push	bc
	push	de
	call	_vdp_set_screen5
	pop	de
	pop	bc
;demo.c:454: vdp_register(VDP_MODE3,modes); // interlace on, screen mode pal or ntsc
	ld	b,e
	push	bc
	push	bc
	inc	sp
...
;demo.c:456: puts("demo start\r\n");
	...
	pop	af
	pop	bc
;demo.c:458: scratch_clear();
	push	bc
	call	_scratch_clear
	pop	bc
;demo.c:459: vdp_load_palette(scratch);
	push	bc
	ld	hl,#_scratch
	push	hl
	call	_vdp_load_palette
	pop	af
	pop	bc
;demo.c:461: vdp_register(VDP_VOFFSET,0);
	push	bc
	ld	hl,#0x0017
	push	hl
	call	_vdp_register
	pop	af
	pop	bc
;demo.c:462: pal_load("TWISTER PL5",32);
	push	bc
	ld	a,#0x20
	push	af
	inc	sp
	...
	inc	sp
	pop	bc
;demo.c:463: vdp_load_palette(cur_palette);
	push	bc
	ld	hl,#_cur_palette
	push	hl
	call	_vdp_load_palette
	pop	af
	pop	bc
;demo.c:465: memset((uint8_t *) &packbuffer, 0, 3498);
	push	bc
	ld	hl,#0x0DAA
	push	hl
	ld	a,#0x00
	...
	inc	sp
	pop	bc
;demo.c:466: raw_load("TWISTER PCK", 3498, packbuffer);
	push	bc
	ld	hl,#_packbuffer
	push	hl
	ld	hl,#0x0DAA
	...
	pop	af
	pop	bc
;demo.c:467: bitbuster(packbuffer,0x8000,VRAM_0); // to page 0
	push	bc
	ld	a,#0x01
	push	af
	inc	sp
...
;demo.c:539: waitVB();
		halt 
;demo.c:540: uninstall_isr();
	call	_uninstall_isr
;demo.c:541: PLY_Stop();
	call	_PLY_Stop
;demo.c:542: PLY_SendRegisters();
	call	_PLY_SendRegisters
;demo.c:544: screen(0);
	ld	a,#0x00
	push	af
