...
; This file was generated Sat Feb 24 17:22:51 2018
;--------------------------------------------------------
	.module demo
	.optsdcc -mz80
...
;demo.c:340: int ff = 0;
	...
	ld	iy,#_ff
	ld	1 (iy),#0x00
;demo.c:369: int bulbflipper = 1;
	ld	iy,#_bulbflipper
	ld	0 (iy),#0x01
	ld	iy,#_bulbflipper
	ld	1 (iy),#0x00
;demo.c:371: int ff1,ff2 = 0;
	ld	iy,#_ff2
	ld	0 (iy),#0x00
	ld	iy,#_ff2
	ld	1 (iy),#0x00
;demo.c:439: uint8_t lx = 0;
	ld	iy,#_lx
	ld	0 (iy),#0x00
;demo.c:440: uint8_t ly = 0;
	ld	iy,#_ly
	ld	0 (iy),#0x00
;demo.c:508: static int xo = 0;
	ld	iy,#_xo
	ld	0 (iy),#0x00
	ld	iy,#_xo
	ld	1 (iy),#0x00
;demo.c:509: static int yo = 0;
	ld	iy,#_yo
	ld	0 (iy),#0x00
	ld	iy,#_yo
	ld	1 (iy),#0x00
;demo.c:510: static int po = 0;
	ld	iy,#_po
	ld	0 (iy),#0x00
	ld	iy,#_po
	ld	1 (iy),#0x00
;demo.c:511: static int fffaaa = 0;
	ld	iy,#_fffaaa
	ld	0 (iy),#0x00
	ld	iy,#_fffaaa
	ld	1 (iy),#0x00
...
_twister:
	...
	add	hl,sp
	ld	sp,hl
;demo.c:346: vdp_register(8,0x2); // no sprites
	ld	hl,#0x0208
	push	hl
	call	_vdp_register
	pop	af
;demo.c:348: cmd.size_x = 70;
	ld	hl,#0x0004
	add	hl,sp
	ld	c,l
	ld	b,h
	...
	inc	hl
	ld	(hl),#0x00
;demo.c:349: cmd.size_y = 2;
	ld	hl,#0x000A
	add	hl,bc
	ld	(hl),#0x02
	inc	hl
	ld	(hl),#0x00
;demo.c:350: cmd.data = 0;
	ld	hl,#0x000C
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:351: cmd.argument = 0x04; // from 70xY to left
	ld	hl,#0x000D
	add	hl,bc
	ex	de,hl
	ld	a,#0x04
	ld	(de),a
;demo.c:352: cmd.command = 0xe0; // vram to vram, y only
	ld	hl,#0x000E
	add	hl,bc
	ex	de,hl
	ld	a,#0xE0
	ld	(de),a
;demo.c:353: cmd.source_x = 70;
	ld	l,c
	ld	h,b
	ld	(hl),#0x46
	inc	hl
	ld	(hl),#0x00
;demo.c:354: cmd.dest_x = 70;
	ld	l,c
	ld	h,b
	inc	hl
	inc	hl
...
00101$:
	...
	sbc	a,#0x00
	jp	P,00104$
;demo.c:357: cmd.source_y = ((sintab[(ff+(y>>1)) & 255])>>1)+320;
	ld	hl,#0x0004
	add	hl,sp
	ex	de,hl
	ld	hl,#0x0002
...
;demo.c:356: for (y = 0; y < 212; y+=2) {
	...
	jp	00101$
00104$:
;demo.c:363: msx2_palette(4,ff>>2,ff>>3,ff>>2);
	ld	hl,#_ff + 0
	ld	c,(hl)
	ld	hl,#_ff + 1
	ld	b,(hl)
...
;demo.c:378: cmd.size_x = 72;
	...
	inc	hl
	ld	(hl),#0x00
;demo.c:379: cmd.size_y = 8;
	ld	hl,#0x000A
	add	hl,bc
	ld	(hl),#0x08
	inc	hl
	ld	(hl),#0x00
;demo.c:380: cmd.data = 0;
	ld	hl,#0x000C
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:381: cmd.argument = 0x04; // from 72xY to left
	ld	hl,#0x000D
	add	hl,bc
	ex	de,hl
	ld	a,#0x04
	ld	(de),a
;demo.c:382: cmd.command = 0xe0; // vram to vram, y only
	ld	hl,#0x000E
	add	hl,bc
	ex	de,hl
	ld	a,#0xE0
	ld	(de),a
;demo.c:383: cmd.source_x = 72;
	ld	l,c
	ld	h,b
	ld	(hl),#0x48
	inc	hl
	ld	(hl),#0x00
;demo.c:384: cmd.dest_x = 72;
	inc	bc
	inc	bc
	inc	bc
	inc	bc
...
00104$:
	...
	sbc	a,#0x00
	jp	P,00107$
;demo.c:387: cmd.source_y = ((sintab[(ff1+(y)) & 255])>>1)+320;
	ld	hl,#0x0004
	add	hl,sp
	ex	de,hl
	ld	hl,#0x0002
...
;demo.c:395: cmd.size_x = 72;
	...
	inc	hl
	ld	(hl),#0x00
;demo.c:396: cmd.size_y = 8;
	ld	hl,#0x000A
	add	hl,bc
	ld	(hl),#0x08
	inc	hl
	ld	(hl),#0x00
;demo.c:397: cmd.data = 0;
	ld	hl,#0x000C
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:398: cmd.argument = 0x00; // from 182xY to right
	ld	hl,#0x000D
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:399: cmd.command = 0xe0; // vram to vram, y only
	ld	hl,#0x000E
	add	hl,bc
	ex	de,hl
	ld	a,#0xE0
	ld	(de),a
;demo.c:400: cmd.source_x = 182;
	ld	l,c
	ld	h,b
	ld	(hl),#0xB6
	inc	hl
	ld	(hl),#0x00
;demo.c:401: cmd.dest_x = 182;
	inc	bc
	inc	bc
	inc	bc
	inc	bc
...
00108$:
	...
	sbc	a,#0x00
	jp	P,00111$
;demo.c:404: cmd.source_y = ((sintab[(ff2+(y>>1)) & 255])>>1)+320;
	ld	hl,#0x0004
	add	hl,sp
	ex	de,hl
	ld	hl,#0x0002
...
;demo.c:408: ff2+=3;
	...
	ld	(hl),a
00103$:
;demo.c:411: bulbflipper = -bulbflipper;
	xor	a,a
	ld	iy,#_bulbflipper
	ld	a,#0x00
	sbc	a,0 (iy)
	...
	ret
_bulbs_end::
;demo.c:442: void do_letter(char cc) {
;	---------------------------------
; Function do_letter
; ---------------------------------
_do_letter_start::
...
;demo.c:444: int cidx = cc - 65;
	...
	adc	a,#0xFF
	ld	-16 (ix),a
;demo.c:445: cmd.source_x = 127+font_x[cidx];
	ld	hl,#0x0004
	add	hl,sp
	ex	de,hl
	ld	a,#<_font_x
	...
	inc	hl
	ld	(hl),b
;demo.c:446: cmd.source_y = 256+font_y[cidx];
	ld	hl,#0x0004
	add	hl,sp
	ld	c,l
	ld	b,h
...
;demo.c:448: cmd.dest_y = ly;
	...
	inc	hl
	ld	(hl),d
;demo.c:449: cmd.size_x = font_w[cidx];
	ld	hl,#0x0008
	add	hl,bc
	ld	-19 (ix),l
	ld	-18 (ix),h
	...
	inc	hl
	ld	(hl),d
;demo.c:450: cmd.size_y = 8;
	ld	hl,#0x000A
	add	hl,bc
	ld	(hl),#0x08
	inc	hl
	ld	(hl),#0x00
;demo.c:451: cmd.argument = 0x00;
	ld	hl,#0x000D
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:452: cmd.command = 0x90; // logical vram to vram
	ld	hl,#0x000E
	add	hl,bc
	ex	de,hl
	ld	a,#0x90
	ld	(de),a
;demo.c:453: vdp_copier(&cmd);
	push	bc
	call	_vdp_copier
	pop	af
;demo.c:454: lx+=font_w[cidx]-1;
	ld	a,#<_font_w
	add	a,-17 (ix)
	ld	c,a
	ld	a,#>_font_w
...
_font_w:
	...
	.db 0x00
	.db 0x00
;demo.c:458: void do_letter_tall(char cc) {
;	---------------------------------
...
;demo.c:460: int cidx = cc - 65;
	...
	adc	a,#0xFF
	ld	-16 (ix),a
;demo.c:461: cmd.source_x = 127+font_x[cidx];
	ld	hl,#0x0004
	add	hl,sp
	ex	de,hl
	ld	a,#<_font_x
	...
	inc	hl
	ld	(hl),b
;demo.c:462: cmd.source_y = 256+font_y[cidx]-1;
	ld	hl,#0x0004
	add	hl,sp
	ld	c,l
	ld	b,h
...
;demo.c:464: cmd.dest_y = ly;
	...
	inc	hl
	ld	(hl),d
;demo.c:465: cmd.size_x = font_w[cidx];
	ld	hl,#0x0008
	add	hl,bc
	ld	-19 (ix),l
	ld	-18 (ix),h
	...
	inc	hl
	ld	(hl),d
;demo.c:466: cmd.size_y = 10;
	ld	hl,#0x000A
	add	hl,bc
	ld	(hl),#0x0A
	inc	hl
	ld	(hl),#0x00
;demo.c:467: cmd.argument = 0x00;
	ld	hl,#0x000D
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:468: cmd.command = 0x90; // logical vram to vram
	ld	hl,#0x000E
	add	hl,bc
	ex	de,hl
	ld	a,#0x90
...
;demo.c:470: lx+=font_w[cidx]-1;
	...
	ret
_do_letter_tall_end::
;demo.c:473: void drawstr(char* str, uint8_t x, uint8_t y) {
;	---------------------------------
; Function drawstr
; ---------------------------------
_drawstr_start::
...
00107$:
	...
	or	a,a
	jr	Z,00110$
;demo.c:478: char ltr = *c++; 
	inc	bc
;demo.c:479: if (ltr == ' ') lx+=4;
	ld	a,d
	sub	a,#0x20
	jr	NZ,00105$
	ld	iy,#_lx
	...
	jr	00107$
00105$:
;demo.c:480: else if (ltr == '_') { ly+=9; lx = x; }
	ld	a,d
	sub	a,#0x5F
	jr	NZ,00102$
	ld	hl,#_ly
...
00110$:
	...
	ret
_drawstr_end::
;demo.c:485: void drawsine(char* str, uint8_t x, uint8_t y) {
;	---------------------------------
; Function drawsine
; ---------------------------------
_drawsine_start::
...
00104$:
	...
	or	a,a
	jp	Z,00107$
;demo.c:490: char ltr = *c++; 
	inc	bc
	ld	-1 (ix),e
;demo.c:491: ly = y+(sintabx[(lx+vbicount>>1) & 255]>>4);
	ld	hl,#_lx + 0
	ld	e,(hl)
	ld	d,#0x00
	ld	hl,#_vbicount
...
;demo.c:492: if (ltr == ' ') lx+=4;
	...
	jp	00104$
00102$:
;demo.c:493: else do_letter_tall(ltr);
	push	bc
	ld	a,-1 (ix)
	push	af
	inc	sp
...
00107$:
	...
	ret
_drawsine_end::
;demo.c:497: void font() {
;	---------------------------------
; Function font
; ---------------------------------
_font_start::
_font:
;demo.c:498: drawstr("THE QUICK BROWN FOX",74,20);
	ld	hl,#0x144A
	push	hl
	ld	hl,#__str_0
	push	hl
	...
	pop	af
	pop	af
;demo.c:499: drawstr("JUMPS OVER THE LAZY DOG",74,29);
	ld	hl,#0x1D4A
	push	hl
	ld	hl,#__str_1
	push	hl
	...
	pop	af
	pop	af
;demo.c:501: drawstr("the quick brown fox",74,40);
	ld	hl,#0x284A
	push	hl
	ld	hl,#__str_2
	push	hl
	...
	pop	af
	pop	af
;demo.c:502: drawstr("jumps over the lazy dog",74,49);
	ld	hl,#0x314A
	push	hl
	ld	hl,#__str_3
	push	hl
	...
	pop	af
	pop	af
;demo.c:504: drawstr("This is a test of the_emergency alert system__This is only a test__Please locate your_nearest exit and proceed_to your gate at once",74,60);
	ld	hl,#0x3C4A
	push	hl
	ld	hl,#__str_4
	push	hl
...
_do_animplay:
	...
	add	hl,sp
	ld	sp,hl
;demo.c:518: for (y = 0; y < 106; y+=1) {
	ld	-1 (ix),#0x00
00107$:
	ld	a,-1 (ix)
	sub	a,#0x6A
	jp	NC,00110$
;demo.c:519: cmd.source_x = xo;
	ld	hl,#0x0004
	add	hl,sp
	ex	de,hl
	ld	bc,(_xo)
	...
	inc	hl
	ld	(hl),b
;demo.c:520: cmd.source_y = 256+po+yo+(y>>1);
	ld	hl,#0x0004
	add	hl,sp
	ld	c,l
	ld	b,h
	...
	inc	hl
	ld	(hl),d
;demo.c:521: cmd.dest_x = 0;
	ld	hl,#0x0004
	add	hl,bc
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:522: cmd.dest_y = (y<<1);
	ld	hl,#0x0006
	add	hl,bc
	ld	-20 (ix),l
	ld	-19 (ix),h
	...
	inc	hl
	ld	(hl),d
;demo.c:523: cmd.size_x = 128;
	ld	hl,#0x0008
	add	hl,bc
	ld	(hl),#0x80
	inc	hl
	ld	(hl),#0x00
;demo.c:524: cmd.size_y = 1;
	ld	hl,#0x000A
	add	hl,bc
	ld	(hl),#0x01
	inc	hl
	ld	(hl),#0x00
;demo.c:525: cmd.data = 0;
	ld	hl,#0x000C
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:526: cmd.argument = 0x00;
	ld	hl,#0x000D
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:527: cmd.command = 0xD0;
	ld	hl,#0x000E
	add	hl,bc
	ex	de,hl
	ld	a,#0xD0
	ld	(de),a
;demo.c:528: vdp_copier(&cmd);
	push	bc
	call	_vdp_copier
	pop	af
;demo.c:518: for (y = 0; y < 106; y+=1) {
	...
	jp	00107$
00110$:
;demo.c:531: for (y = 0; y < 106; y+=1) {
	ld	-1 (ix),#0x00
00111$:
	ld	a,-1 (ix)
	sub	a,#0x6A
	jp	NC,00114$
;demo.c:532: cmd.source_x = xo;
	ld	hl,#0x0004
	add	hl,sp
	ex	de,hl
	ld	bc,(_xo)
	...
	inc	hl
	ld	(hl),b
;demo.c:533: cmd.source_y = 256+po+yo+(y>>1);
	ld	hl,#0x0004
	add	hl,sp
	ld	c,l
	ld	b,h
	...
	inc	hl
	ld	(hl),d
;demo.c:534: cmd.dest_x = 128;
	ld	hl,#0x0004
	add	hl,bc
	ld	(hl),#0x80
	inc	hl
	ld	(hl),#0x00
;demo.c:535: cmd.dest_y = (y<<1);
	ld	hl,#0x0006
	add	hl,bc
	ld	-20 (ix),l
	ld	-19 (ix),h
	...
	inc	hl
	ld	(hl),d
;demo.c:536: cmd.size_x = 128;
	ld	hl,#0x0008
	add	hl,bc
	ld	(hl),#0x80
	inc	hl
	ld	(hl),#0x00
;demo.c:537: cmd.size_y = 1;
	ld	hl,#0x000A
	add	hl,bc
	ld	(hl),#0x01
	inc	hl
	ld	(hl),#0x00
;demo.c:538: cmd.data = 0;
	ld	hl,#0x000C
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:539: cmd.argument = 0x00;
	ld	hl,#0x000D
	add	hl,bc
	ex	de,hl
	ld	a,#0x00
	ld	(de),a
;demo.c:540: cmd.command = 0xd2; // logical vram to vram, xor
	ld	hl,#0x000E
	add	hl,bc
	ex	de,hl
	ld	a,#0xD2
	ld	(de),a
;demo.c:541: vdp_copier(&cmd);
	push	bc
	call	_vdp_copier
	pop	af
;demo.c:531: for (y = 0; y < 106; y+=1) {
...
;demo.c:548: yo+=53;
	...
	inc	hl
	ld	(hl),a
;demo.c:549: if (yo >= 212) { yo = 0; po+=256; }
	ld	a,(#_yo+0)
	sub	a,#0xD4
	ld	a,(#_yo+1)
	sbc	a,#0x00
...
;demo.c:551: po = 0;
	...
	ld	(hl), #0x00
00106$:
;demo.c:556: msx2_palette(15,3+sintab[fffaaa & 255]>>5,3,4);
	ld	hl,#_fffaaa + 0
	ld	c,(hl)
	ld	b,#0x00
	ld	hl,#_sintab
	...
	pop	af
	pop	af
;demo.c:557: msx2_palette(3,2+sintab[fffaaa & 255]>>5,0,0);
	ld	hl,#_fffaaa + 0
	ld	c,(hl)
	ld	b,#0x00
	ld	hl,#_sintab
...
00132$:
	...
	ret
_do_animplay_end::
;demo.c:567: void main() {
;	---------------------------------
; Function main
; ---------------------------------
_main_start::
_main:
;demo.c:568: unsigned char quit=0;
	ld	c,#0x00
;demo.c:569: int modes = 128; // interlace bit on
	ld	de,#0x0080
;demo.c:573: spindown();
	push	bc
	push	de
...
;demo.c:588: puts("music init...");
	...
	pop	de
	pop	bc
;demo.c:590: PLY_SongPtr = (char *)0x0103;
...
;demo.c:594: if(isvdp2())
	...
	or	a,a
	jr	Z,00102$
;demo.c:596: modes+=2; // pal
	ld	de,#0x0082
00102$:
;demo.c:600: vdp_set_screen5();
	push	bc
	push	de
	call	_vdp_set_screen5
	pop	de
	pop	bc
;demo.c:602: vdp_register(VDP_MODE3,modes); // interlace on, screen mode pal or ntsc
	ld	b,e
	push	bc
	push	bc
	inc	sp
...
;demo.c:604: puts("demo start\r\n");
	...
	pop	af
	pop	bc
;demo.c:606: scratch_clear();
	push	bc
	call	_scratch_clear
	pop	bc
;demo.c:607: vdp_load_palette(scratch);
	push	bc
	ld	hl,#_scratch
	push	hl
	call	_vdp_load_palette
	pop	af
	pop	bc
;demo.c:609: vdp_register(VDP_VOFFSET,0);
	push	bc
	ld	hl,#0x0017
	push	hl
	call	_vdp_register
	pop	af
	pop	bc
;demo.c:616: pal_load("BULBS   PL5",32);
	push	bc
	ld	a,#0x20
	push	af
	inc	sp
	...
	inc	sp
	pop	bc
;demo.c:617: vdp_load_palette(cur_palette);
	push	bc
	ld	hl,#_cur_palette
	push	hl
	call	_vdp_load_palette
	pop	af
	pop	bc
;demo.c:623: memset((uint8_t *) &packbuffer, 0, 2431);
	push	bc
	ld	hl,#0x097F
	push	hl
	ld	a,#0x00
	...
	inc	sp
	pop	bc
;demo.c:624: raw_load("BULBS   PCK", 2431, packbuffer);
	push	bc
	ld	hl,#_packbuffer
	push	hl
	ld	hl,#0x097F
	...
	pop	af
	pop	bc
;demo.c:625: bitbuster(packbuffer,0x8000,VRAM_0); // to page 2
	push	bc
	ld	a,#0x01
	push	af
	inc	sp
	...
	inc	sp
	pop	bc
;demo.c:647: vdp_set_write_address(0, 0);
	push	bc
	ld	hl,#0x0000
	push	hl
	ld	a,#0x00
	...
	inc	sp
	pop	bc
;demo.c:648: memset((uint8_t *) &scratch, 0, 256);
	push	bc
	ld	hl,#0x0100
	push	hl
	ld	a,#0x00
	...
	inc	sp
	pop	bc
;demo.c:650: for (i = 0; i < 212; i++) {		
	ld	de,#0x00D4
00110$:
;demo.c:651: vdp_load_screen(scratch, 128);
	push	bc
	push	de
	ld	a,#0x80
	push	af
...
;demo.c:684: waitVB();
		halt 
;demo.c:685: uninstall_isr();
	call	_uninstall_isr
;demo.c:686: PLY_Stop();
	call	_PLY_Stop
;demo.c:687: PLY_SendRegisters();
	call	_PLY_SendRegisters
;demo.c:689: screen(0);
	ld	a,#0x00
	push	af
