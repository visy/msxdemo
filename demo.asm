...
; This file was generated Tue Feb 27 00:22:22 2018
;--------------------------------------------------------
	.module demo
	.optsdcc -mz80
...
;demo.c:541: int twinited = 0;
	...
	ld	iy,#_twinited
	ld	1 (iy),#0x00
;demo.c:591: int bulbflipper = 1;
	ld	iy,#_bulbflipper
	ld	0 (iy),#0x01
	ld	iy,#_bulbflipper
	ld	1 (iy),#0x00
;demo.c:593: int ff1,ff2 = 0;
	ld	iy,#_ff2
	ld	0 (iy),#0x00
	ld	iy,#_ff2
	ld	1 (iy),#0x00
;demo.c:594: int ender = 212;
	ld	iy,#_ender
	ld	0 (iy),#0xD4
	ld	iy,#_ender
	ld	1 (iy),#0x00
;demo.c:595: int enderdir = -1;
	ld	iy,#_enderdir
	ld	0 (iy),#0xFF
	ld	iy,#_enderdir
	ld	1 (iy),#0xFF
;demo.c:650: static int xo = 0;
	ld	iy,#_xo
	ld	0 (iy),#0x00
	ld	iy,#_xo
	ld	1 (iy),#0x00
;demo.c:651: static int yo = 0;
	ld	iy,#_yo
	ld	0 (iy),#0x00
	ld	iy,#_yo
	ld	1 (iy),#0x00
;demo.c:652: static int po = 0;
	ld	iy,#_po
	ld	0 (iy),#0x00
	ld	iy,#_po
	ld	1 (iy),#0x00
;demo.c:653: static int fffaaa = 0;
	ld	iy,#_fffaaa
	ld	0 (iy),#0x00
	ld	iy,#_fffaaa
	ld	1 (iy),#0x00
;demo.c:655: int anim_init = 0;
	ld	iy,#_anim_init
	ld	0 (iy),#0x00
	ld	iy,#_anim_init
	ld	1 (iy),#0x00
;demo.c:709: uint8_t boxes_init = 0;
	ld	iy,#_boxes_init
	ld	0 (iy),#0x00
;demo.c:710: int buffer = 1;
	ld	iy,#_buffer
	ld	0 (iy),#0x01
	ld	iy,#_buffer
	ld	1 (iy),#0x00
;demo.c:711: int dbly = 0;
	ld	iy,#_dbly
	ld	0 (iy),#0x00
	ld	iy,#_dbly
	ld	1 (iy),#0x00
;demo.c:712: int prevx = -1;
	ld	iy,#_prevx
	ld	0 (iy),#0xFF
	ld	iy,#_prevx
	ld	1 (iy),#0xFF
;demo.c:737: int bx = 256-42;
	ld	iy,#_bx
	ld	0 (iy),#0xD6
	ld	iy,#_bx
	ld	1 (iy),#0x00
;demo.c:738: int by = 84;
	ld	iy,#_by
	ld	0 (iy),#0x54
	ld	iy,#_by
	ld	1 (iy),#0x00
;demo.c:739: int bt = 0;
	...
	ld	iy,#_bt
	ld	1 (iy),#0x00
;demo.c:740: int bxx = 0;
	ld	iy,#_bxx
	ld	0 (iy),#0x00
	ld	iy,#_bxx
	ld	1 (iy),#0x00
;demo.c:741: int byy = 0;
	ld	iy,#_byy
	ld	0 (iy),#0x00
	ld	iy,#_byy
	ld	1 (iy),#0x00
;demo.c:742: int bo = 0;
	...
	ld	iy,#_bo
	ld	1 (iy),#0x00
;demo.c:744: int bonc = 0;
	ld	iy,#_bonc
	ld	0 (iy),#0x00
	ld	iy,#_bonc
	ld	1 (iy),#0x00
;demo.c:745: int pbx = 0;
	ld	iy,#_pbx
	ld	0 (iy),#0x00
	ld	iy,#_pbx
	ld	1 (iy),#0x00
;demo.c:746: int pbt = 0;
	ld	iy,#_pbt
	ld	0 (iy),#0x00
	ld	iy,#_pbt
	ld	1 (iy),#0x00
;demo.c:848: uint8_t tri_inited = 0;
	ld	iy,#_tri_inited
	ld	0 (iy),#0x00
;demo.c:876: char tripal[9] = {
	ld	hl,#_tripal
	call	__initrleblock
	.db	9
	...
	.db	0x02
	.db	0
;demo.c:882: uint8_t tripaltick = 0;
	ld	iy,#_tripaltick
	ld	0 (iy),#0x00
;demo.c:884: int triframes = 0;
	ld	iy,#_triframes
	ld	0 (iy),#0x00
	ld	iy,#_triframes
	ld	1 (iy),#0x00
...
;demo.c:550: cmd.data = 0;
	ld	a,#0x00
	ld	(#_cmd + 12),a
;demo.c:551: cmd.argument = 0x04; // from 70xY to left
	ld	a,#0x04
	ld	(#_cmd + 13),a
;demo.c:552: cmd.command = 0xe0; // vram to vram, y only
	ld	bc,#_cmd + 14
	ld	a,#0xE0
	ld	(bc),a
;demo.c:553: cmd.source_x = 256;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:554: cmd.dest_x = 256;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
...
;demo.c:564: twinited = 1;
	...
	ld	hl,#_twinited + 1
	ld	(hl), #0x00
;demo.c:565: vdp_register(8,0x2); // no sprites
	ld	hl,#0x0208
	push	hl
	call	_vdp_register
	pop	af
;demo.c:566: vdp_load_palette(twister_palette);
...
;demo.c:567: font();
	call	_font
00102$:
;demo.c:570: cmd.size_x = 70;
	ld	hl, #_cmd + 8
	ld	(hl),#0x46
	inc	hl
	ld	(hl),#0x00
;demo.c:571: cmd.size_y = 2;
	ld	hl, #_cmd + 10
	ld	(hl),#0x02
	inc	hl
	ld	(hl),#0x00
;demo.c:572: cmd.data = 0;
	ld	a,#0x00
	ld	(#_cmd + 12),a
;demo.c:573: cmd.argument = 0x04; // from 70xY to left
	ld	a,#0x04
	ld	(#_cmd + 13),a
;demo.c:574: cmd.command = 0xe0; // vram to vram, y only
	ld	bc,#_cmd + 14
	ld	a,#0xE0
	ld	(bc),a
;demo.c:575: cmd.source_x = 70;
	ld	hl,#_cmd
	ld	(hl),#0x46
	inc	hl
	ld	(hl),#0x00
;demo.c:576: cmd.dest_x = 70;
	ld	hl, #_cmd + 4
	ld	(hl),#0x46
	inc	hl
	ld	(hl),#0x00
;demo.c:578: for (y = 0; y < 212; y+=2) {
	ld	-2 (ix),#0x00
	ld	-1 (ix),#0x00
00107$:
	ld	a,-2 (ix)
	...
	sbc	a,#0x00
	jp	P,00110$
;demo.c:579: cmd.source_y = ((sintab[(ff+(y>>1)) & 255])>>1)+512+64;
	ld	de,#_cmd + 2
	ld	c,-2 (ix)
	ld	b,-1 (ix)
	sra	b
...
;demo.c:578: for (y = 0; y < 212; y+=2) {
	...
	jp	00107$
00110$:
;demo.c:585: msx2_palette(4,ff>>2,ff>>3,ff>>2);
	ld	hl,#_ff + 0
	ld	c,(hl)
	ld	hl,#_ff + 1
	ld	b,(hl)
...
00130$:
	jp	00108$
00131$:
;demo.c:610: cmd.size_x = 72;
	ld	de,#_cmd + 8
	ex	de,hl
	ld	(hl),#0x48
	inc	hl
	ld	(hl),#0x00
;demo.c:611: cmd.size_y = 16;
	ld	de,#_cmd + 10
	ex	de,hl
	ld	(hl),#0x10
	inc	hl
	ld	(hl),#0x00
;demo.c:612: cmd.data = 0;
	ld	de,#_cmd + 12
	ld	a,#0x00
	ld	(de),a
;demo.c:613: cmd.argument = 0x04; // from 72xY to left
	ld	de,#_cmd + 13
	ld	a,#0x04
	ld	(de),a
;demo.c:614: cmd.command = 0xe0; // vram to vram, y only
	ld	de,#_cmd + 14
	ld	a,#0xE0
	ld	(de),a
;demo.c:615: cmd.source_x = 72;
	ld	hl,#_cmd
	ld	(hl),#0x48
	inc	hl
	ld	(hl),#0x00
;demo.c:616: cmd.dest_x = 72;
	ld	de,#_cmd + 4
	ld	l,e
	ld	h,d
	ld	(hl),#0x48
	inc	hl
	ld	(hl),#0x00
;demo.c:618: for (y = ender; y < enderend; y+=16) {
	ld	bc,(_ender)
	ld	e,c
	ld	d,b
00110$:
	...
	sbc	a,-1 (ix)
	jp	P,00113$
;demo.c:619: cmd.source_y = ((sintab[(ff1+(y)) & 255])>>1)+320;
	ld	hl,#_cmd + 2
	ld	-4 (ix),l
	ld	-3 (ix),h
	ld	a,(#_ff1+0)
	...
	inc	hl
	ld	(hl),b
;demo.c:620: cmd.dest_y = y;
	ld	hl, #_cmd + 6
	ld	(hl),e
	inc	hl
	ld	(hl),d
;demo.c:621: vdp_copier(&cmd);
	push	de
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
...
;demo.c:623: ff1+=4;
	...
	jp	00109$
00108$:
;demo.c:627: cmd.size_x = 72;
	ld	hl, #_cmd + 8
	ld	(hl),#0x48
	inc	hl
	ld	(hl),#0x00
;demo.c:628: cmd.size_y = 16;
	ld	hl, #_cmd + 10
	ld	(hl),#0x10
	inc	hl
	ld	(hl),#0x00
;demo.c:629: cmd.data = 0;
;demo.c:630: cmd.argument = 0x00; // from 182xY to right
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:631: cmd.command = 0xe0; // vram to vram, y only
	ld	bc,#_cmd + 14
	ld	a,#0xE0
	ld	(bc),a
;demo.c:632: cmd.source_x = 182;
	ld	hl,#_cmd
	ld	(hl),#0xB6
	inc	hl
	ld	(hl),#0x00
;demo.c:633: cmd.dest_x = 182;
	ld	hl, #_cmd + 4
	ld	(hl),#0xB6
	inc	hl
	ld	(hl),#0x00
;demo.c:635: for (y = ender; y < enderend; y+=16) {
	ld	bc,(_ender)
00114$:
	ld	a,c
	sub	a,-2 (ix)
	...
	sbc	a,-1 (ix)
	jp	P,00117$
;demo.c:636: cmd.source_y = ((sintab[(ff2+(y)) & 255])>>1)+320;
	ld	hl,#_cmd + 2
	ld	-4 (ix),l
	ld	-3 (ix),h
	ld	a,(#_ff2+0)
	...
	inc	hl
	ld	(hl),d
;demo.c:637: cmd.dest_y = y;
	ld	de,#_cmd + 6
	ex	de,hl
	ld	(hl),c
	inc	hl
	ld	(hl),b
;demo.c:638: vdp_copier(&cmd);
	push	bc
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
...
;demo.c:640: ff2+=4;
	...
	ld	(hl),a
00109$:
;demo.c:643: bulbflipper = -bulbflipper;
	xor	a,a
	ld	iy,#_bulbflipper
	ld	a,#0x00
	sbc	a,0 (iy)
...
_animplay:
	...
	push	af
	dec	sp
;demo.c:662: if (anim_init == 0) {
	ld	a,(#_anim_init+0)
	ld	hl,#_anim_init + 1
	or	a,(hl)
	jr	NZ,00117$
;demo.c:664: vdp_register(0,0);
	ld	hl,#0x0000
	push	hl
	call	_vdp_register
	pop	af
;demo.c:665: vdp_register(1,0);
	ld	hl,#0x0001
	push	hl
	call	_vdp_register
	pop	af
;demo.c:670: vdp_set_screen5();
	call	_vdp_set_screen5
;demo.c:671: vdp_register(1,0x60);
	ld	hl,#0x6001
	push	hl
	call	_vdp_register
	pop	af
;demo.c:672: vdp_register(9,2); // 192 lines
	ld	hl,#0x0209
	push	hl
	call	_vdp_register
	pop	af
;demo.c:675: anim_init = 1;
	ld	hl,#_anim_init + 0
	ld	(hl), #0x01
	ld	hl,#_anim_init + 1
	ld	(hl), #0x00
;demo.c:676: vdp_load_palette(tf_palette);
	ld	hl,#_tf_palette
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:679: for (y = 0; y < 96; y+=1) {
00117$:
	ld	-1 (ix),#0x00
00109$:
	ld	a,-1 (ix)
	sub	a,#0x60
	jp	NC,00112$
;demo.c:680: cmd.source_x = xo;
	ld	de,(_xo)
	ld	hl,#_cmd
	ld	(hl),e
	inc	hl
	ld	(hl),d
;demo.c:681: cmd.source_y = 256+po+yo+(y>>1);
	ld	de,#_cmd + 2
	ld	a,(#_po+0)
	ld	c,a
	ld	a,(#_po+1)
	...
	inc	hl
	ld	(hl),b
;demo.c:682: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:683: cmd.dest_y = (y<<1);
	ld	bc,#_cmd + 6
	ld	e,-1 (ix)
	ld	d,#0x00
	sla	e
	...
	inc	hl
	ld	(hl),d
;demo.c:684: cmd.size_x = 128;
	ld	hl, #_cmd + 8
	ld	(hl),#0x80
	inc	hl
	ld	(hl),#0x00
;demo.c:685: cmd.size_y = 1;
	ld	hl, #_cmd + 10
	ld	(hl),#0x01
	inc	hl
	ld	(hl),#0x00
;demo.c:686: cmd.data = 0;
;demo.c:687: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:688: cmd.command = 0xD0;
	ld	a,#0xD0
	ld	(#_cmd + 14),a
...
;demo.c:695: yo+=48;
	...
	inc	hl
	ld	(hl),a
;demo.c:696: if (yo >= 192) { yo = 0; po+=256; }
	ld	a,(#_yo+0)
	sub	a,#0xC0
	ld	a,(#_yo+1)
	sbc	a,#0x00
...
00124$:
	...
	ret
_animplay_end::
;demo.c:717: void drawbox(int box_x, int box_y, uint8_t x, uint8_t y) {
;	---------------------------------
; Function drawbox
; ---------------------------------
_drawbox_start::
...
;demo.c:718: dbly = 0;
	...
	ld	hl,#_dbly + 1
	ld	(hl), #0x00
;demo.c:720: cmd.source_x = box_x * 42;
	ld	e,4 (ix)
	ld	d,5 (ix)
	ld	l,e
	ld	h,d
	...
	inc	hl
	ld	(hl),b
;demo.c:721: cmd.source_y = 768+box_y * 42;
	ld	bc,#_cmd + 2
	ld	e,6 (ix)
	ld	d,7 (ix)
	ld	l,e
...
;demo.c:723: cmd.dest_y = dbly+y;
	...
	inc	hl
	ld	(hl),d
;demo.c:724: cmd.size_x = 42;
	ld	hl, #_cmd + 8
	ld	(hl),#0x2A
	inc	hl
	ld	(hl),#0x00
;demo.c:725: cmd.size_y = 42;
	ld	hl, #_cmd + 10
	ld	(hl),#0x2A
	inc	hl
	ld	(hl),#0x00
;demo.c:726: cmd.data = 0;
;demo.c:727: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:728: cmd.command = 0x98; // TIMP sprite
	ld	a,#0x98
	ld	(#_cmd + 14),a
;demo.c:729: vdp_copier(&cmd);
	push	de
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
...
;demo.c:734: prevby = box_y;
	...
	ret
_drawbox_end::
;demo.c:748: void boxes() {
;	---------------------------------
; Function boxes
; ---------------------------------
_boxes_start::
_boxes:
;demo.c:752: if (bonc == 1) {
	ld	a,(#_bonc+0)
	sub	a,#0x01
	jr	NZ,00156$
	ld	a,(#_bonc+1)
...
00156$:
	jr	00102$
00157$:
;demo.c:754: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:755: cmd.source_y = 256;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:756: cmd.dest_x = pbx;
	ld	bc,#_cmd + 4
	ld	de,(_pbx)
	ld	l,c
	ld	h,b
...
;demo.c:757: cmd.dest_y = pbt;
	...
	inc	hl
	ld	(hl),d
;demo.c:758: cmd.size_x = 42;
	ld	hl, #_cmd + 8
	ld	(hl),#0x2A
	inc	hl
	ld	(hl),#0x00
;demo.c:759: cmd.size_y = 42;
	ld	hl, #_cmd + 10
	ld	(hl),#0x2A
	inc	hl
	ld	(hl),#0x00
;demo.c:760: cmd.data = 0;
;demo.c:761: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:762: cmd.command = 0xD0; // HMMM
	ld	a,#0xD0
	ld	(#_cmd + 14),a
;demo.c:763: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
00102$:
;demo.c:767: if (boxes_init == 0) {
	xor	a,a
	ld	hl,#_boxes_init + 0
	or	a,(hl)
	jp	NZ,00104$
;demo.c:768: boxes_init = 1;
	ld	iy,#_boxes_init
	ld	0 (iy),#0x01
;demo.c:770: cmd.size_x = 8;
	ld	hl, #_cmd + 8
	ld	(hl),#0x08
	inc	hl
	ld	(hl),#0x00
;demo.c:771: cmd.size_y = 212;
	ld	hl, #_cmd + 10
	ld	(hl),#0xD4
	inc	hl
	ld	(hl),#0x00
;demo.c:772: cmd.data = 0;
;demo.c:773: cmd.argument = 0x00; // from 70xY to left
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:774: cmd.command = 0xd0; // vram to vram, y only
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:775: cmd.source_x = 248;
	ld	hl,#_cmd
	ld	(hl),#0xF8
	inc	hl
	ld	(hl),#0x00
;demo.c:776: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:777: cmd.dest_y = 0;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:779: for (x = 248; x >= 0; x-=8) {
	ld	bc,#0x00F8
00131$:
	ld	a,b
	bit	7,a
...
;demo.c:780: waitVB();
		halt 
;demo.c:781: cmd.dest_x = x;
	ld	de,#_cmd + 4
	ex	de,hl
	ld	(hl),c
	inc	hl
	ld	(hl),b
;demo.c:782: cmd.dest_y = 0;
	ld	de,#_cmd + 6
	ex	de,hl
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:783: vdp_copier(&cmd);
	push	bc
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
	pop	bc
;demo.c:784: cmd.dest_y = 256;
	ld	de,#_cmd + 6
	ex	de,hl
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:785: vdp_copier(&cmd);
	push	bc
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
...
;demo.c:779: for (x = 248; x >= 0; x-=8) {
	...
	jr	00131$
00134$:
;demo.c:788: drawsine("LET US STOP   WE ARE BUILDING WALLS BETWEEN",8,180);
	ld	hl,#0xB408
	push	hl
	ld	hl,#__str_9
	push	hl
	...
	pop	af
	pop	af
;demo.c:790: vdp_load_palette(boxes_palette);
	ld	hl,#_boxes_palette
	push	hl
	call	_vdp_load_palette
	pop	af
00104$:
;demo.c:793: if (bt >= 80) bt+=6;
	ld	a,(#_bt+0)
	sub	a,#0x50
	ld	a,(#_bt+1)
	sbc	a,#0x00
	...
	ld	(hl),a
00106$:
;demo.c:794: if (bt < 80 && bt >= 60) bt+=5;
	ld	a,(#_bt+0)
	sub	a,#0x50
	ld	a,(#_bt+1)
	sbc	a,#0x00
	...
	ld	(hl),a
00108$:
;demo.c:795: if (bt < 60 && bt >= 40) bt+=4;
	ld	a,(#_bt+0)
	sub	a,#0x3C
	ld	a,(#_bt+1)
	sbc	a,#0x00
	...
	ld	(hl),a
00111$:
;demo.c:796: if (bt < 40 && bt >= 10) bt+=3;
	ld	a,(#_bt+0)
	sub	a,#0x28
	ld	a,(#_bt+1)
	sbc	a,#0x00
...
;demo.c:797: if (bt < 10 ) bt+=2;
	...
	ld	(hl),a
00117$:
;demo.c:801: cmd.source_x = bx;
	ld	bc,(_bx)
	ld	hl,#_cmd
	ld	(hl),c
	inc	hl
	ld	(hl),b
;demo.c:802: cmd.source_y = bt;
	ld	bc,#_cmd + 2
	ld	de,(_bt)
	ld	l,c
	ld	h,b
	...
	inc	hl
	ld	(hl),d
;demo.c:803: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:804: cmd.dest_y = 256;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:805: cmd.size_x = 42;
	ld	hl, #_cmd + 8
	ld	(hl),#0x2A
	inc	hl
	ld	(hl),#0x00
;demo.c:806: cmd.size_y = 42;
	ld	hl, #_cmd + 10
	ld	(hl),#0x2A
	inc	hl
	ld	(hl),#0x00
...
;demo.c:815: waitVB();
		halt 
;demo.c:817: drawbox(bxx,byy,bx,bt);
	ld	hl,#_bt + 0
	ld	c,(hl)
	ld	hl,#_bx + 0
	ld	b,(hl)
...
__str_9:
	...
	.db 0x00
;demo.c:850: void drawtritile(uint8_t tx, int ty, uint8_t x, uint8_t y) {
;	---------------------------------
...
;demo.c:854: cmd.dest_y = y;
	...
	inc	hl
	ld	(hl),d
;demo.c:855: cmd.size_x = 16;
	ld	hl, #_cmd + 8
	ld	(hl),#0x10
	inc	hl
	ld	(hl),#0x00
;demo.c:856: cmd.size_y = 16;
	ld	hl, #_cmd + 10
	ld	(hl),#0x10
	inc	hl
	ld	(hl),#0x00
;demo.c:857: cmd.data = 0;
;demo.c:858: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:859: cmd.command = 0xd0; // HMMM
	ld	a,#0xD0
	ld	(#_cmd + 14),a
;demo.c:860: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
	...
	ret
_drawtritile_end::
;demo.c:863: void drawtilescreen(char* tripic) {
;	---------------------------------
...
00103$:
	...
	sbc	a,#0x01
	jp	P,00106$
;demo.c:868: drawtritile(tri_lookup_x[tripic[i]],tri_lookup_y[tripic[i]],x,y);
	ld	a,-4 (ix)
	ld	-8 (ix),a
	ld	a,-2 (ix)
	ld	-7 (ix),a
...
_tritiles:
	...
	add	hl,sp
	ld	sp,hl
;demo.c:893: if (tri_inited == 0) {
	xor	a,a
	ld	hl,#_tri_inited + 0
	or	a,(hl)
	jp	NZ,00102$
;demo.c:894: tri_inited = 1;
	ld	iy,#_tri_inited
	ld	0 (iy),#0x01
;demo.c:896: cmd.size_x = 256;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:897: cmd.size_y = 1;
	ld	hl, #_cmd + 10
	ld	(hl),#0x01
	inc	hl
	ld	(hl),#0x00
;demo.c:898: cmd.data = 0;
;demo.c:899: cmd.argument = 0x00; // from 70xY to left
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:900: cmd.command = 0xd0; // vram to vram, y only
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:901: cmd.source_x = 0;
	...
	inc	hl
	ld	(hl),#0x00
;demo.c:902: cmd.source_y = 255;
	ld	hl, #_cmd + 2
	ld	(hl),#0xFF
	inc	hl
	ld	(hl),#0x00
;demo.c:903: cmd.dest_y = 0;
	ld	bc,#_cmd + 6
	ld	l,c
	ld	h,b
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:905: for (x = 0; x < 212; x++) {
	ld	-2 (ix),#0xD4
	ld	-1 (ix),#0x00
00121$:
;demo.c:906: waitVB();
		halt 
;demo.c:907: cmd.dest_x = 0;
	ld	de,#_cmd + 4
	ex	de,hl
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:908: cmd.dest_y = x;
	ld	de,#_cmd + 6
	ld	c,-2 (ix)
	ld	b,-1 (ix)
	dec	bc
...
;demo.c:905: for (x = 0; x < 212; x++) {
	...
	or	a,-1 (ix)
	jr	NZ,00121$
;demo.c:911: vdp_register(9,2); // 192 lines
	ld	hl,#0x0209
	push	hl
	call	_vdp_register
	pop	af
;demo.c:913: vdp_load_palette(boxes_palette);
	ld	hl,#_boxes_palette
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:914: msx2_palette(15,0,0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x0F
	push	hl
	...
	pop	af
	pop	af
;demo.c:916: drawtilescreen(tri_center);
	ld	hl,#_tri_center
	push	hl
	call	_drawtilescreen
	pop	af
00102$:
;demo.c:921: triframes++;
	ld	iy,#_triframes
	inc	0 (iy)
	jr	NZ,00142$
	ld	iy,#_triframes
...
00143$:
	jr	00104$
00144$:
;demo.c:923: drawtilescreen(tri_up);
	ld	hl,#_tri_up
	push	hl
	call	_drawtilescreen
	pop	af
00104$:
;demo.c:926: if (triframes == 400) {
	ld	a,(#_triframes+0)
	sub	a,#0x90
	jr	NZ,00145$
	ld	a,(#_triframes+1)
...
00145$:
	jr	00106$
00146$:
;demo.c:927: drawtilescreen(tri_dia);
	ld	hl,#_tri_dia
	push	hl
	call	_drawtilescreen
	pop	af
00106$:
;demo.c:929: if (triframes == 600) {
	ld	a,(#_triframes+0)
	sub	a,#0x58
	jr	NZ,00147$
	ld	a,(#_triframes+1)
...
00147$:
	jr	00108$
00148$:
;demo.c:930: drawtilescreen(tri_side1);
	ld	hl,#_tri_side1
	push	hl
	call	_drawtilescreen
	pop	af
00108$:
;demo.c:932: if (triframes == 700) {
	ld	a,(#_triframes+0)
	sub	a,#0xBC
	jr	NZ,00149$
	ld	a,(#_triframes+1)
...
00149$:
	jr	00110$
00150$:
;demo.c:933: drawtilescreen(tri_side2);
	ld	hl,#_tri_side2
	push	hl
	call	_drawtilescreen
	pop	af
00110$:
;demo.c:935: if (triframes == 800) {
	ld	a,(#_triframes+0)
	sub	a,#0x20
	jr	NZ,00151$
	ld	a,(#_triframes+1)
...
00151$:
	jr	00112$
00152$:
;demo.c:936: drawtilescreen(tri_side1);
	ld	hl,#_tri_side1
	push	hl
	call	_drawtilescreen
	pop	af
00112$:
;demo.c:938: if (triframes == 900) {
	ld	a,(#_triframes+0)
	sub	a,#0x84
	jr	NZ,00153$
	ld	a,(#_triframes+1)
...
00153$:
	jr	00114$
00154$:
;demo.c:939: drawtilescreen(tri_side2);
	ld	hl,#_tri_side2
	push	hl
	call	_drawtilescreen
	pop	af
00114$:
;demo.c:941: if (triframes == 1000) {
	ld	a,(#_triframes+0)
	sub	a,#0xE8
	jr	NZ,00155$
	ld	a,(#_triframes+1)
...
00155$:
	jr	00116$
00156$:
;demo.c:942: triframes = 0;
	ld	hl,#_triframes + 0
	ld	(hl), #0x00
	ld	hl,#_triframes + 1
	ld	(hl), #0x00
;demo.c:943: drawtilescreen(tri_center);
	ld	hl,#_tri_center
	push	hl
	call	_drawtilescreen
	pop	af
00116$:
;demo.c:946: msx2_palette(3,tripal[0],tripal[1],tripal[2]);
	ld	hl,#_tripal + 2
	ld	c,(hl)
	ld	de,#_tripal + 1
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:947: msx2_palette(13,tripal[3],tripal[4],tripal[5]);
	ld	hl,#_tripal + 5
	ld	c,(hl)
	ld	de,#_tripal + 4
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:948: msx2_palette(5,tripal[6],tripal[7],tripal[8]);
	ld	hl,#_tripal + 8
	ld	c,(hl)
	ld	de,#_tripal + 7
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:951: tripaltick++;
	ld	iy,#_tripaltick
	inc	0 (iy)
;demo.c:952: if (tripaltick > 6) {
	ld	a,#0x06
	ld	iy,#_tripaltick
	sub	a,0 (iy)
	jp	NC,00126$
;demo.c:954: r = tripal[0];
	ld	hl,#_tripal
	ld	c,(hl)
	ld	-3 (ix),c
;demo.c:955: g = tripal[1];
	ld	de,#_tripal + 1
	ld	a,(de)
	ld	-4 (ix),a
;demo.c:956: b = tripal[2];
	ld	hl,#_tripal + 2
	ld	e,(hl)
	ld	-5 (ix),e
;demo.c:958: for (x = 0; x < 6; x++) {
	ld	-2 (ix),#0x00
	ld	-1 (ix),#0x00
00122$:
	ld	a,-2 (ix)
	...
	sbc	a,#0x00
	jp	P,00125$
;demo.c:959: tripal[x] = tripal[x+3];
	ld	a,#<_tripal
	add	a,-2 (ix)
	ld	c,a
	ld	a,#>_tripal
...
00157$:
	jr	00122$
00125$:
;demo.c:962: tripal[6] = r;
	ld	bc,#_tripal + 6
	ld	a,-3 (ix)
	ld	(bc),a
;demo.c:963: tripal[7] = g;
	ld	bc,#_tripal + 7
	ld	a,-4 (ix)
	ld	(bc),a
;demo.c:964: tripal[8] = b;
	ld	bc,#_tripal + 8
	ld	a,-5 (ix)
	ld	(bc),a
;demo.c:965: tripaltick = 0;
	ld	hl,#_tripaltick + 0
	ld	(hl), #0x00
00126$:
	ld	sp,ix
...
;demo.c:975: waitVB();
		halt 
;demo.c:976: uninstall_isr();
	call	_uninstall_isr
;demo.c:977: PLY_Stop();
	call	_PLY_Stop
;demo.c:978: PLY_SendRegisters();
	call	_PLY_SendRegisters
;demo.c:980: screen(0);
	ld	a,#0x00
	push	af
...
_main:
	...
	add	hl,sp
	ld	sp,hl
;demo.c:988: unsigned char quit=0;
	ld	-1 (ix),#0x00
;demo.c:989: int modes = 128; // interlace bit on
	ld	-3 (ix),#0x80
	ld	-2 (ix),#0x00
;demo.c:995: spindown();
	call	_spindown
;demo.c:997: puts("demo init\r\n\r\n");
	ld	hl,#__str_11
	push	hl
	call	_puts
	pop	af
;demo.c:999: for (y = 0; y < 2; y++) {
	ld	-7 (ix),#0x00
	ld	-6 (ix),#0x00
00127$:
	ld	a,-7 (ix)
...
00123$:
	...
	sbc	a,#0x00
	jp	P,00129$
;demo.c:1001: tri_lookup_x[(y*16)+x] = x * 16;
	ld	a,-7 (ix)
	rlca
	rlca
	rlca
	...
	ld	h,d
	ld	(hl),e
;demo.c:1002: tri_lookup_y[(y*16)+x] = (768+129)+(y * 16);
	sla	b
	ld	a,#<_tri_lookup_y
	add	a,b
	ld	l,a
...
00155$:
	jp	00127$
00130$:
;demo.c:1017: puts("music init...");
	ld	hl,#__str_12
	push	hl
	call	_puts
	pop	af
;demo.c:1019: PLY_SongPtr = (char *)0x0103;
	ld	hl,#_PLY_SongPtr + 0
	ld	(hl), #0x03
	ld	hl,#_PLY_SongPtr + 1
	ld	(hl), #0x01
;demo.c:1020: PLY_Init();
	call	_PLY_Init
;demo.c:1021: puts("done.\r\n");
	ld	hl,#__str_13
	push	hl
	call	_puts
	pop	af
;demo.c:1023: puts("detecting vdp type...");
	ld	hl,#__str_14
	push	hl
	call	_puts
	pop	af
;demo.c:1024: if(isvdp2())
	call	_isvdp2
	xor	a,a
	or	a,l
	jr	Z,00102$
;demo.c:1026: puts(" vdp2 found!\r\n\r\n");
	ld	hl,#__str_15
	push	hl
	call	_puts
	pop	af
;demo.c:1027: modes+=2; // pal
	ld	-3 (ix),#0x82
	ld	-2 (ix),#0x00
	jr	00103$
00102$:
;demo.c:1030: puts(" vdp1 found.\r\nSorry, this demo requires a VDP2 with 128k for VRAM.\r\n\r\n");
	ld	hl,#__str_16
	push	hl
	call	_puts
	pop	af
;demo.c:1031: do_quit();
	call	_do_quit
00103$:
;demo.c:1034: pal_load("TWISTER PL5",32,1);
	ld	hl,#0x0001
	push	hl
	ld	a,#0x20
	push	af
	...
	pop	af
	inc	sp
;demo.c:1035: memcpy(twister_palette, cur_palette, 32);
	ld	hl,#0x0020
	push	hl
	ld	hl,#_cur_palette
	push	hl
	...
	pop	af
	pop	af
;demo.c:1036: pal_load("TF1     PL5",32,1);
	ld	hl,#0x0001
	push	hl
	ld	a,#0x20
	push	af
	...
	pop	af
	inc	sp
;demo.c:1037: memcpy(tf_palette, cur_palette, 32);
	ld	hl,#0x0020
	push	hl
	ld	hl,#_cur_palette
	push	hl
	...
	pop	af
	pop	af
;demo.c:1038: pal_load("BOXES   PL5",32,1);
	ld	hl,#0x0001
	push	hl
	ld	a,#0x20
	push	af
	...
	pop	af
	inc	sp
;demo.c:1039: memcpy(boxes_palette, cur_palette, 32);
	ld	hl,#0x0020
	push	hl
	ld	hl,#_cur_palette
	push	hl
	...
	pop	af
	pop	af
;demo.c:1042: pal_load("BULBS   PL5",32,1);
	ld	hl,#0x0001
	push	hl
	ld	a,#0x20
	push	af
	...
	pop	af
	inc	sp
;demo.c:1044: pck_load("BULBS   PCK",2431,0x8000,VRAM_0,1);
	ld	hl,#0x0001
	push	hl
	ld	l, #0x01
	push	hl
	...
	add	iy,sp
	ld	sp,iy
;demo.c:1046: pck_load("TWISTER PCK",4032,0x0000,VRAM_1,1);
	ld	hl,#0x0001
	push	hl
	ld	l, #0x00
	push	hl
	...
	add	iy,sp
	ld	sp,iy
;demo.c:1047: pck_load("BOXES   PCK",4500,0x8000,VRAM_1,1);
	ld	hl,#0x0001
	push	hl
	ld	l, #0x00
	push	hl
	...
	add	iy,sp
	ld	sp,iy
;demo.c:1051: vdp_set_screen5();
	call	_vdp_set_screen5
;demo.c:1053: vdp_register(VDP_MODE3,modes); // interlace on, screen mode pal or ntsc
	ld	a,-3 (ix)
	push	af
	inc	sp
	ld	a,#0x09
	...
	call	_vdp_register
	pop	af
;demo.c:1056: puts("demo start\r\n");
	ld	hl,#__str_24
	push	hl
	call	_puts
	pop	af
;demo.c:1058: scratch_clear();
	call	_scratch_clear
;demo.c:1059: vdp_load_palette(scratch);
	ld	hl,#_scratch
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1061: pck_load("DSSLOGO PCK",2154,0x0000,VRAM_0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x01
	push	hl
	...
	add	iy,sp
	ld	sp,iy
;demo.c:1062: pal_load("DSSLOGO PL5",32,1);
	ld	hl,#0x0001
	push	hl
	ld	a,#0x20
	push	af
	...
	pop	af
	inc	sp
;demo.c:1063: vdp_load_palette(cur_palette);
	ld	hl,#_cur_palette
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1065: vdp_register(VDP_VOFFSET,0);
	ld	hl,#0x0017
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1077: install_isr(my_isr);
	ld	hl,#_my_isr
	push	hl
	call	_install_isr
	pop	af
;demo.c:1079: while (!quit) {
00120$:
	xor	a,a
	or	a,-1 (ix)
	jp	NZ,00122$
;demo.c:1082: if (vbicount < 64) { 
	ld	a,(#_vbicount+0)
	sub	a,#0x40
	ld	iy,#_vbicount
	ld	a,1 (iy)
...
;demo.c:1084: fadein(); 
	call	_fadein
00105$:
;demo.c:1086: if (vbicount >= 192 && vbicount < 800) {
	ld	a,(#_vbicount+0)
	sub	a,#0xC0
	ld	a,(#_vbicount+1)
	sbc	a,#0x00
...
;demo.c:1088: bulbs();
	call	_bulbs
00107$:
;demo.c:1091: if (vbicount >= 800 && vbicount < 1500) {
	ld	a,(#_vbicount+0)
	sub	a,#0x20
	ld	a,(#_vbicount+1)
	sbc	a,#0x03
...
;demo.c:1093: twister();
	call	_twister
00110$:
;demo.c:1096: if (vbicount >= 1500 && vbicount < 2200) {
	ld	a,(#_vbicount+0)
	sub	a,#0xDC
	ld	a,(#_vbicount+1)
	sbc	a,#0x05
...
;demo.c:1097: boxes();
	call	_boxes
00113$:
;demo.c:1101: if (vbicount >= 2200 && vbicount < 5800) {
	ld	a,(#_vbicount+0)
	sub	a,#0x98
	ld	a,(#_vbicount+1)
	sbc	a,#0x08
...
;demo.c:1102: waitVB();
		halt 
;demo.c:1103: tritiles();
	call	_tritiles
00116$:
;demo.c:1107: if(space())
	ld	hl,#0x0108
	push	hl
	call	_ispressed
	pop	af
