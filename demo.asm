...
; This file was generated Sat Mar 24 23:51:19 2018
;--------------------------------------------------------
	.module demo
	.optsdcc -mz80
...
;demo.c:1510: int credittimer = 0;
	...
	ld	iy,#_credittimer
	ld	1 (iy),#0x00
;demo.c:1511: int musicstopped = 0;
	ld	iy,#_musicstopped
	ld	0 (iy),#0x00
	ld	iy,#_musicstopped
	ld	1 (iy),#0x00
...
;demo.c:1506: }
	ret
_waiter_end::
;demo.c:1512: void credits() {
;	---------------------------------
; Function credits
; ---------------------------------
_credits_start::
_credits:
;demo.c:1515: if (initcredits == 0) {
	ld	a,(#_initcredits+0)
	ld	hl,#_initcredits + 1
	or	a,(hl)
	jp	NZ,00102$
;demo.c:1516: scratch_clear();
	call	_scratch_clear
;demo.c:1517: vdp_load_palette(scratch);
	ld	hl,#_scratch
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1519: vdp_register(0,8); // mode 512x212
	ld	hl,#0x0800
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1520: vdp_register(9,130); // 50hz,192
	ld	hl,#0x8209
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1522: uninstall_isr();
	call	_uninstall_isr
;demo.c:1523: PLY_Stop();
	call	_PLY_Stop
;demo.c:1524: PLY_SendRegisters();
	call	_PLY_SendRegisters
;demo.c:1526: initcredits = 1;
	ld	hl,#_initcredits + 0
	ld	(hl), #0x01
	ld	hl,#_initcredits + 1
	ld	(hl), #0x00
;demo.c:1528: bitbuster(crebuffer2,0x0000,VRAM_0);
	ld	a,#0x01
	push	af
	inc	sp
	ld	hl,#0x0000
	...
	pop	af
	inc	sp
;demo.c:1530: cmd.size_x = 512;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x02
;demo.c:1531: cmd.size_y = 212;
	ld	hl, #_cmd + 10
	ld	(hl),#0xD4
	inc	hl
	ld	(hl),#0x00
;demo.c:1532: cmd.data = 0;
;demo.c:1533: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1534: cmd.command = 0xd0; 
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1535: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1536: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1537: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1538: cmd.dest_y = 256;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1539: vdp_copier(&cmd);
	...
	call	_vdp_copier
	pop	af
;demo.c:1541: bitbuster(crebuffer3,0x0000,VRAM_0);
	ld	a,#0x01
	push	af
	inc	sp
	ld	hl,#0x0000
	...
	pop	af
	inc	sp
;demo.c:1543: cmd.size_x = 512;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x02
;demo.c:1544: cmd.size_y = 212;
	ld	hl, #_cmd + 10
	ld	(hl),#0xD4
	inc	hl
	ld	(hl),#0x00
;demo.c:1545: cmd.data = 0;
;demo.c:1546: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1547: cmd.command = 0xd0; 
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1548: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1549: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1550: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1551: cmd.dest_y = 512;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x02
;demo.c:1552: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1554: bitbuster(crebuffer1,0x0000,VRAM_0);
	ld	a,#0x01
	push	af
	inc	sp
	ld	hl,#0x0000
	...
	pop	af
	inc	sp
;demo.c:1556: install_isr(my_isr);
	ld	hl,#_my_isr
	push	hl
	call	_install_isr
	pop	af
;demo.c:1558: memcpy(cur_palette, credits_palette, 32);
	ld	hl,#0x0020
	push	hl
	...
	pop	af
	pop	af
;demo.c:1560: scratch_clear();
	call	_scratch_clear
00102$:
;demo.c:1563: if (credittimer < 100) fadein();
	ld	a,(#_credittimer+0)
	sub	a,#0x64
	ld	a,(#_credittimer+1)
	sbc	a,#0x00
	...
	call	_fadein
00104$:
;demo.c:1565: if(credittimer == 200) vdp_register(2, 0x3f);
	ld	a,(#_credittimer+0)
	sub	a,#0xC8
	jr	NZ,00118$
	ld	a,(#_credittimer+1)
...
00119$:
	...
	pop	af
00106$:
;demo.c:1566: if(credittimer == 400) vdp_register(2, 0x5f);
	ld	a,(#_credittimer+0)
	sub	a,#0x90
	jr	NZ,00120$
	ld	a,(#_credittimer+1)
...
;demo.c:1568: credittimer++;
	...
	inc	1 (iy)
00122$:
;demo.c:1569: if (credittimer == 600) {
	ld	a,(#_credittimer+0)
	sub	a,#0x58
	ret	NZ
	ld	a,(#_credittimer+1)
	...
	ret
00124$:
;demo.c:1570: vdp_load_palette(scratch);
	ld	hl,#_scratch
	push	hl
	call	_vdp_load_palette
	pop	af
...
;demo.c:1581: waitVB();
		halt 
;demo.c:1582: uninstall_isr();
	call	_uninstall_isr
;demo.c:1583: PLY_Stop();
	call	_PLY_Stop
;demo.c:1584: PLY_SendRegisters();
	call	_PLY_SendRegisters
;demo.c:1586: screen(0);
	ld	a,#0x00
	push	af
	inc	sp
	call	_screen
	inc	sp
;demo.c:1587: vdp_load_palette(twister_palette);
	ld	hl,#_twister_palette
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1589: puts("bye friends.\r\n\r\n");
	ld	hl,#__str_26
	push	hl
	call	_puts
	pop	af
...
;demo.c:1604: spindown();
	call	_spindown
;demo.c:1606: puts("[starting DSS MSX demosystem]\r\n\r\n");
	ld	hl,#__str_27
	push	hl
	call	_puts
	pop	af
...
00152$:
	jp	00122$
00125$:
;demo.c:1620: puts("init sweet PSG bleeps...");
	ld	hl,#__str_28
	push	hl
	call	_puts
	pop	af
...
;demo.c:1624: puts("done.\r\n");
	...
	call	_puts
	pop	af
;demo.c:1626: puts("detecting ya vdp type...\r\n");
	ld	hl,#__str_30
	push	hl
	call	_puts
	pop	af
...
;demo.c:1633: do_quit();
	call	_do_quit
00103$:
;demo.c:1636: pal_load("TWISTER PL5",32,0);
	ld	hl,#0x0000
	push	hl
	ld	a,#0x20
	push	af
...
;demo.c:1637: memcpy(twister_palette, cur_palette, 32);
	...
	pop	af
	pop	af
;demo.c:1638: pal_load("LF      PL5",32,0);
	ld	hl,#0x0000
	push	hl
	ld	a,#0x20
	push	af
...
;demo.c:1639: memcpy(tf_palette, cur_palette, 32);
	...
	pop	af
	pop	af
;demo.c:1640: pal_load("BOXES   PL5",32,0);
	ld	hl,#0x0000
	push	hl
	ld	a,#0x20
	push	af
...
;demo.c:1641: memcpy(boxes_palette, cur_palette, 32);
	...
	pop	af
	pop	af
;demo.c:1642: pal_load("BULBS   PL5",32,0);
	ld	hl,#0x0000
	push	hl
	ld	a,#0x20
	push	af
...
;demo.c:1643: memcpy(bulbs_palette, cur_palette, 32);
	...
	pop	af
	pop	af
;demo.c:1644: pal_load("CREDIT1 PL6",32,0);
	ld	hl,#0x0000
	push	hl
	ld	a,#0x20
	push	af
	...
	pop	af
	inc	sp
;demo.c:1645: memcpy(credits_palette, cur_palette, 32);
	ld	hl,#0x0020
	push	hl
	ld	hl,#_cur_palette
	push	hl
	...
	pop	af
	pop	af
;demo.c:1647: puts("all good, starting the demo!\r\n");
	ld	hl,#__str_38
	push	hl
	call	_puts
	pop	af
...
;demo.c:1654: pause();
	call	_pause
;demo.c:1656: scratch_clear();
	call	_scratch_clear
;demo.c:1657: vdp_load_palette(scratch);
	ld	hl,#_scratch
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1659: vdp_set_screen5();
	call	_vdp_set_screen5
;demo.c:1661: pck_load("BULBS   PCK",2431,0x0000,VRAM_0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x01
	push	hl
	...
	add	iy,sp
	ld	sp,iy
;demo.c:1663: cmd.size_x = 256;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1664: cmd.size_y = 212;
	ld	hl, #_cmd + 10
	ld	(hl),#0xD4
	inc	hl
	ld	(hl),#0x00
;demo.c:1665: cmd.data = 0;
;demo.c:1666: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1667: cmd.command = 0xd0; 
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1668: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1669: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1670: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1671: cmd.dest_y = 256;
	...
	inc	hl
	ld	(hl),#0x01
;demo.c:1672: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1674: pck_load("TWISTER PCK",4032,0x0000,VRAM_0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x01
	push	hl
	...
	add	iy,sp
	ld	sp,iy
;demo.c:1676: cmd.size_x = 256;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1677: cmd.size_y = 212;
	ld	hl, #_cmd + 10
	ld	(hl),#0xD4
	inc	hl
	ld	(hl),#0x00
;demo.c:1678: cmd.data = 0;
;demo.c:1679: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1680: cmd.command = 0xd0; 
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1681: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1682: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1683: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1684: cmd.dest_y = 512;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x02
;demo.c:1685: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1688: pck_load("BOXES   PCK",3002,0x0000,VRAM_0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x01
	push	hl
	...
	add	iy,sp
	ld	sp,iy
;demo.c:1689: cmd.size_x = 256;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1690: cmd.size_y = 212;
	ld	hl, #_cmd + 10
	ld	(hl),#0xD4
	inc	hl
	ld	(hl),#0x00
;demo.c:1691: cmd.data = 0;
;demo.c:1692: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1693: cmd.command = 0xd0; 
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1694: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1695: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1696: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1697: cmd.dest_y = 768;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x03
;demo.c:1698: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1700: memset((uint8_t *) &crebuffer1, 0, 3323);
	ld	hl,#0x0CFB
	push	hl
	ld	a,#0x00
	push	af
	...
	pop	af
	inc	sp
;demo.c:1701: raw_load("CREDIT1 PCK", 3323, crebuffer1,0);
	ld	hl,#0x0000
	push	hl
	ld	hl,#_crebuffer1
	push	hl
	...
	pop	af
	pop	af
;demo.c:1702: memset((uint8_t *) &crebuffer2, 0, 4724);
	ld	hl,#0x1274
	push	hl
	ld	a,#0x00
	push	af
	...
	pop	af
	inc	sp
;demo.c:1703: raw_load("CREDIT2 PCK", 4724, crebuffer2,0);
	ld	hl,#0x0000
	push	hl
	ld	hl,#_crebuffer2
	push	hl
	...
	pop	af
	pop	af
;demo.c:1704: memset((uint8_t *) &crebuffer3, 0, 3723);
	ld	hl,#0x0E8B
	push	hl
	ld	a,#0x00
	push	af
	...
	pop	af
	inc	sp
;demo.c:1705: raw_load("CREDIT3 PCK", 3723, crebuffer3,0);
	ld	hl,#0x0000
	push	hl
	ld	hl,#_crebuffer3
	push	hl
	...
	pop	af
	pop	af
;demo.c:1707: scratch_clear();
	call	_scratch_clear
;demo.c:1708: vdp_load_palette(scratch);
	ld	hl,#_scratch
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1710: pck_load("DSSLOGO PCK",2154,0x0000,VRAM_0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x01
	push	hl
	...
	add	iy,sp
	ld	sp,iy
;demo.c:1712: cmd.size_x = 108;
	ld	hl, #_cmd + 8
	ld	(hl),#0x6C
	inc	hl
	ld	(hl),#0x00
;demo.c:1713: cmd.size_y = 116;
	ld	hl, #_cmd + 10
	ld	(hl),#0x74
	inc	hl
	ld	(hl),#0x00
...
;demo.c:1716: cmd.command = 0xd0; 
	...
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1717: cmd.source_x = 75;
	ld	hl,#_cmd
	ld	(hl),#0x4B
	inc	hl
	ld	(hl),#0x00
;demo.c:1718: cmd.source_y = 50;
	ld	hl, #_cmd + 2
	ld	(hl),#0x32
	inc	hl
	ld	(hl),#0x00
;demo.c:1719: cmd.dest_x = 75;
	ld	hl, #_cmd + 4
	ld	(hl),#0x4B
	inc	hl
	ld	(hl),#0x00
;demo.c:1720: cmd.dest_y = 256;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1721: vdp_copier(&cmd);
	...
	call	_vdp_copier
	pop	af
;demo.c:1723: cmd.size_x = 108;
	ld	hl, #_cmd + 8
	ld	(hl),#0x6C
	inc	hl
	ld	(hl),#0x00
;demo.c:1724: cmd.size_y = 60;
	ld	hl, #_cmd + 10
	ld	(hl),#0x3C
	inc	hl
	ld	(hl),#0x00
;demo.c:1725: cmd.data = 0;
;demo.c:1726: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1727: cmd.command = 0xd0; 
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1728: cmd.source_x = 75;
	ld	hl,#_cmd
	ld	(hl),#0x4B
	inc	hl
	ld	(hl),#0x00
;demo.c:1729: cmd.source_y = 256+110;
	ld	hl, #_cmd + 2
	ld	(hl),#0x6E
	inc	hl
	ld	(hl),#0x01
;demo.c:1730: cmd.dest_x = 75;
	ld	hl, #_cmd + 4
	ld	(hl),#0x4B
	inc	hl
	ld	(hl),#0x00
;demo.c:1731: cmd.dest_y = 40;
	ld	hl, #_cmd + 6
	ld	(hl),#0x28
	inc	hl
	ld	(hl),#0x00
;demo.c:1732: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
...
;demo.c:1735: vdp_copier(&cmd);
	...
	call	_vdp_copier
	pop	af
;demo.c:1737: pal_load("DSSLOGO PL5",32,0);
	ld	hl,#0x0000
	push	hl
	ld	a,#0x20
	push	af
	...
	pop	af
	inc	sp
;demo.c:1739: scratch_clear();
	call	_scratch_clear
;demo.c:1741: vdp_register(9,130); // 50hz,212
	ld	hl,#0x8209
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1743: install_isr(my_isr);
	ld	hl,#_my_isr
	push	hl
	call	_install_isr
	pop	af
;demo.c:1747: while (!quit) {
00111$:
	xor	a,a
	or	a,-1 (ix)
	jp	NZ,00113$
;demo.c:1749: if (vbicount >= scenetimings[timeindex+1]) {
	ld	hl,#_timeindex + 0
	ld	c,(hl)
	inc	c
	sla	c
...
;demo.c:1751: timeindex+=2;
	...
	ld	(hl),a
00105$:
;demo.c:1754: if (vbicount >= scenetimings[timeindex] && vbicount < scenetimings[timeindex+1]) {
	ld	hl,#_timeindex + 0
	ld	c,(hl)
	ld	hl,#_timeindex + 1
	ld	b,(hl)
...
;demo.c:1755: waitVB();
		halt 
;demo.c:1756: scenepointers[sceneindex]();
	ld	hl,#_sceneindex + 0
	ld	c,(hl)
	ld	iy,#_sceneindex
	ld	b,1 (iy)
