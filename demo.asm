...
; This file was generated Thu Mar 29 01:09:38 2018
;--------------------------------------------------------
	.module demo
	.optsdcc -mz80
...
;demo.c:891: int ffa = 0;
	...
	ld	iy,#_ffa
	ld	1 (iy),#0x00
;demo.c:1012: uint8_t tri_inited = 0;
	ld	iy,#_tri_inited
	ld	0 (iy),#0x00
;demo.c:1027: int tilei = 0;
	ld	iy,#_tilei
	ld	0 (iy),#0x00
	ld	iy,#_tilei
	ld	1 (iy),#0x00
;demo.c:1028: int tilex = 0;
	ld	iy,#_tilex
	ld	0 (iy),#0x00
	ld	iy,#_tilex
	ld	1 (iy),#0x00
;demo.c:1029: int tiley = 0;
	ld	iy,#_tiley
	ld	0 (iy),#0x00
	ld	iy,#_tiley
	ld	1 (iy),#0x00
;demo.c:1030: uint8_t tiletick = 0;
	ld	iy,#_tiletick
	ld	0 (iy),#0x00
;demo.c:1060: char tripal[9] = {
	ld	hl,#_tripal
	call	__initrleblock
	.db	9
	...
	.db	0x02
	.db	0
;demo.c:1066: uint8_t tripaltick = 0;
	ld	iy,#_tripaltick
	ld	0 (iy),#0x00
;demo.c:1067: uint8_t tripaltick2 = 0;
	ld	iy,#_tripaltick2
	ld	0 (iy),#0x00
;demo.c:1069: int triframes = 0;
	ld	iy,#_triframes
	ld	0 (iy),#0x00
	ld	iy,#_triframes
	ld	1 (iy),#0x00
;demo.c:1234: int powatick = 0;
	ld	iy,#_powatick
	ld	0 (iy),#0x00
	ld	iy,#_powatick
	ld	1 (iy),#0x00
;demo.c:1235: int powa = 0;
	ld	iy,#_powa
	ld	0 (iy),#0x00
	ld	iy,#_powa
	ld	1 (iy),#0x00
;demo.c:1236: uint8_t onceclear = 255;
	ld	iy,#_onceclear
	ld	0 (iy),#0xFF
;demo.c:1281: uint8_t initpoints = 0;
	ld	iy,#_initpoints
	ld	0 (iy),#0x00
;demo.c:1282: int pointframe = 0;
	ld	iy,#_pointframe
	ld	0 (iy),#0x00
	ld	iy,#_pointframe
	ld	1 (iy),#0x00
;demo.c:1285: int greetindex = 0;
	ld	iy,#_greetindex
	ld	0 (iy),#0x00
	ld	iy,#_greetindex
	ld	1 (iy),#0x00
;demo.c:1573: int initcredits = 0;
	ld	iy,#_initcredits
	ld	0 (iy),#0x00
	ld	iy,#_initcredits
	ld	1 (iy),#0x00
;demo.c:1574: int credittimer = 0;
	ld	iy,#_credittimer
	ld	0 (iy),#0x00
	ld	iy,#_credittimer
	ld	1 (iy),#0x00
;demo.c:1575: int musicstopped = 0;
	ld	iy,#_musicstopped
	ld	0 (iy),#0x00
	ld	iy,#_musicstopped
	ld	1 (iy),#0x00
;demo.c:1576: int flipo = 0;
	ld	iy,#_flipo
	ld	0 (iy),#0x00
	ld	iy,#_flipo
	ld	1 (iy),#0x00
;demo.c:1577: int curpage = 0;
	ld	iy,#_curpage
	ld	0 (iy),#0x00
	ld	iy,#_curpage
	ld	1 (iy),#0x00
;demo.c:1578: int myoffs = 0;
	ld	iy,#_myoffs
	ld	0 (iy),#0x00
	ld	iy,#_myoffs
	ld	1 (iy),#0x00
;demo.c:1739: int sceneindex = 0;
	ld	iy,#_sceneindex
	ld	0 (iy),#0x00
	ld	iy,#_sceneindex
	ld	1 (iy),#0x00
;demo.c:1740: int timeindex = 0;
	ld	iy,#_timeindex
	ld	0 (iy),#0x00
	ld	iy,#_timeindex
	ld	1 (iy),#0x00
...
_thewave:
	...
	add	hl,sp
	ld	sp,hl
;demo.c:902: if (initwave == 0) {
	xor	a,a
	ld	hl,#_initwave + 0
	or	a,(hl)
	jp	NZ,00113$
;demo.c:903: initwave = 1;
	ld	hl,#_initwave + 0
	ld	(hl), #0x01
;demo.c:904: for (y = 0; y < 212; y++) {
	ld	-2 (ix),#0x00
00128$:
	ld	a,-2 (ix)
	sub	a,#0xD4
	jp	NC,00131$
;demo.c:905: cmd.size_x = 256;
	ld	de,#_cmd + 8
	ex	de,hl
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:906: cmd.size_y = 2;
	ld	de,#_cmd + 10
	ex	de,hl
	ld	(hl),#0x02
	inc	hl
...
;demo.c:907: cmd.data = 0;
	...
	ld	a,#0x00
	ld	(de),a
;demo.c:908: cmd.argument = 0x00; // from 70xY to left
	ld	de,#_cmd + 13
	ld	a,#0x00
	ld	(de),a
;demo.c:909: cmd.command = 0xd0; // vram to vram, y only
	ld	de,#_cmd + 14
	ld	a,#0xD0
	ld	(de),a
;demo.c:911: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:912: cmd.source_y = 0;
	...
	inc	hl
	ld	(hl),#0x00
;demo.c:913: cmd.dest_x = 0;
	ld	de,#_cmd + 4
	ex	de,hl
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:914: cmd.dest_y = 0+y;
	ld	de,#_cmd + 6
	ld	c,-2 (ix)
	ld	b,#0x00
	ex	de,hl
...
;demo.c:904: for (y = 0; y < 212; y++) {
	...
	jp	00128$
00131$:
;demo.c:921: for (y = 9; y < 15; y+=1) {
	ld	-2 (ix),#0x09
00132$:
	ld	a,-2 (ix)
	sub	a,#0x0F
	jp	NC,00113$
;demo.c:922: for (x = 0; x < 22; x+=1) {
	ld	a,-2 (ix)
	add	a,a
	ld	-7 (ix),a
	ld	-1 (ix),#0x00
00108$:
	...
	sub	a,#0x16
	jp	NC,00134$
;demo.c:923: if (x > 6 && x < 13) continue; 
	ld	a,#0x06
	sub	a,-1 (ix)
	jr	NC,00102$
	ld	a,-1 (ix)
	...
	jp	C,00110$
00102$:
;demo.c:925: if (x <= 6) px=7 + (sintab[(105 + (x<<3) + (y<<3)) & 255]>>4);
	ld	a,#0x06
	sub	a,-1 (ix)
	jp	C,00105$
	ld	d,-1 (ix)
	...
	ld	-3 (ix),a
00105$:
;demo.c:926: if (x >= 13) px=7 + (sintab[(105 + ((23+x)<<3) + ((19+y)<<3)) & 255]>>4);
	ld	a,-1 (ix)
	sub	a,#0x0D
	jp	C,00107$
	ld	e,-1 (ix)
	...
	ld	-3 (ix),a
00107$:
;demo.c:928: cmd.size_x = 11;
	ld	de,#_cmd + 8
	ex	de,hl
	ld	(hl),#0x0B
	inc	hl
	ld	(hl),#0x00
;demo.c:929: cmd.size_y = 28-(14-px);
	ld	hl,#_cmd + 10
	ld	-6 (ix),l
	ld	-5 (ix),h
	ld	a,#0x0E
	...
	inc	hl
	ld	(hl),b
;demo.c:930: cmd.data = 0;
	ld	hl,#_cmd + 12
	ld	(hl),#0x00
;demo.c:931: cmd.argument = 0x00; // from 70xY to left
	ld	hl,#_cmd + 13
	ld	(hl),#0x00
;demo.c:932: cmd.command = 0x98; // vram to vram, y only
	ld	hl,#_cmd + 14
	ld	(hl),#0x98
;demo.c:934: cmd.source_x = twelvetimes[px];
	ld	b,-4 (ix)
	ld	d,-3 (ix)
	sla	b
	rl	d
	...
	inc	hl
	ld	(hl),d
;demo.c:935: cmd.source_y = 768+183+(15-px);
	inc	hl
	ld	-6 (ix),l
	ld	-5 (ix),h
	ld	a,#0xC6
	...
	inc	hl
	ld	(hl),d
;demo.c:936: cmd.dest_x = 0+twelvetimes[x];
	ld	hl,#_cmd + 4
	ld	-6 (ix),l
	ld	-5 (ix),h
	ld	a,-1 (ix)
	...
	inc	hl
	ld	(hl),d
;demo.c:937: cmd.dest_y = 0+bo+(eighttimes[y]+4)+(14-px);
	ld	hl,#_cmd + 6
	ld	-6 (ix),l
	ld	-5 (ix),h
	ld	a,#<_eighttimes
...
;demo.c:938: vdp_copier(&cmd);
	...
	pop	de
	pop	bc
;demo.c:939: cmd.dest_y = 256+bo+(eighttimes[y]+4)+(14-px);
	ld	hl,#_cmd + 6
	ld	-6 (ix),l
	ld	-5 (ix),h
	ld	a,#<_eighttimes
...
00189$:
	...
	jr	00116$
00115$:
;demo.c:947: else { bo = 256; ya = 6;}
	ld	bc,#0x0100
00116$:
;demo.c:949: cmd.size_x = 72;
	ld	de,#_cmd + 8
	ex	de,hl
	ld	(hl),#0x48
	inc	hl
	ld	(hl),#0x00
;demo.c:950: cmd.size_y = 80;
	ld	de,#_cmd + 10
	ex	de,hl
	ld	(hl),#0x50
	inc	hl
...
;demo.c:951: cmd.data = 0;
	...
	ld	a,#0x00
	ld	(de),a
;demo.c:952: cmd.argument = 0x00; // from 70xY to left
	ld	de,#_cmd + 13
	ld	a,#0x00
	ld	(de),a
;demo.c:953: cmd.command = 0xd0; // vram to vram, y only
	ld	de,#_cmd + 14
	ld	a,#0xD0
	ld	(de),a
;demo.c:954: cmd.source_x = 178;
	ld	hl,#_cmd
	ld	(hl),#0xB2
	inc	hl
	ld	(hl),#0x00
;demo.c:955: cmd.source_y = 0;
	ld	de,#_cmd + 2
	ex	de,hl
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:956: cmd.dest_x = 84;
	ld	de,#_cmd + 4
	ex	de,hl
	ld	(hl),#0x54
	inc	hl
	ld	(hl),#0x00
;demo.c:957: cmd.dest_y = 72+bo;
	ld	de,#_cmd + 6
	ld	hl,#0x0048
	add	hl,bc
	ld	c,l
...
;demo.c:958: vdp_copier(&cmd);
	...
	pop	af
	pop	bc
;demo.c:961: for (y = 0; y < 5; y+=1) {
	ld	-2 (ix),#0x00
00140$:
	ld	a,-2 (ix)
	sub	a,#0x05
	jp	NC,00143$
;demo.c:962: for (x = 0; x < 6; x+=1) {
	ld	a,-2 (ix)
	add	a,a
	ld	-7 (ix),a
	ld	-1 (ix),#0x00
00136$:
	...
	sub	a,#0x06
	jp	NC,00142$
;demo.c:964: px=7 + (sintab[(ffa + (x<<(4+(ffa>>7))) + (y<<2)) & 255]>>4);
	ld	a,-1 (ix)
	ld	-6 (ix),a
	ld	-5 (ix),#0x00
	ld	hl,#_ffa + 0
...
;demo.c:966: if (px > 14) px = 14; 
	...
	ld	-3 (ix),#0x00
00120$:
;demo.c:968: cmd.size_x = 12;
	ld	de,#_cmd + 8
	ex	de,hl
	ld	(hl),#0x0C
	inc	hl
	ld	(hl),#0x00
;demo.c:969: cmd.size_y = 11;
	ld	de,#_cmd + 10
	ex	de,hl
	ld	(hl),#0x0B
	inc	hl
	ld	(hl),#0x00
;demo.c:970: cmd.data = 0;
	ld	de,#_cmd + 12
	ld	a,#0x00
	ld	(de),a
;demo.c:971: cmd.argument = 0x00; // from 70xY to left
	ld	de,#_cmd + 13
	ld	a,#0x00
	ld	(de),a
;demo.c:972: cmd.command = 0x98; // vram to vram, y only
	ld	de,#_cmd + 14
	ld	a,#0x98
	ld	(de),a
;demo.c:974: cmd.source_x = twelvetimes[px];
	ld	e,-4 (ix)
	ld	d,-3 (ix)
	sla	e
	rl	d
	...
	inc	hl
	ld	(hl),d
;demo.c:975: cmd.source_y = 768+183+16-px;
	inc	hl
	ld	-6 (ix),l
	ld	-5 (ix),h
	ld	a,#0xC7
	...
	inc	hl
	ld	(hl),d
;demo.c:976: cmd.dest_x = 84+twelvetimes[x];
	ld	hl,#_cmd + 4
	ld	-6 (ix),l
	ld	-5 (ix),h
	ld	a,-1 (ix)
	...
	inc	hl
	ld	(hl),d
;demo.c:977: cmd.dest_y = 72+bo+(eighttimes[y]+4)+(14-px);
	ld	hl,#_cmd + 6
	ld	-6 (ix),l
	ld	-5 (ix),h
	ld	a,#<_eighttimes
...
;demo.c:961: for (y = 0; y < 5; y+=1) {
	...
	jp	00140$
00143$:
;demo.c:983: for (x = 0; x < 6; x+=1) {
	ld	-1 (ix),#0x00
00144$:
	ld	a,-1 (ix)
	sub	a,#0x06
	jp	NC,00147$
;demo.c:984: px=7 + (sintab[(ffa + (x<<(4+(ffa>>7))) + (y<<2)) & 255]>>4);
	ld	a,-1 (ix)
	ld	-9 (ix),a
	ld	-8 (ix),#0x00
	ld	hl,#_ffa + 0
...
;demo.c:986: if (px > 14) px = 14; 
	...
	ld	-3 (ix),#0x00
00124$:
;demo.c:988: cmd.size_x = 12;
	ld	de,#_cmd + 8
	ex	de,hl
	ld	(hl),#0x0C
	inc	hl
	ld	(hl),#0x00
;demo.c:989: cmd.size_y = 27-(14-px);
	ld	hl,#_cmd + 10
	ld	-9 (ix),l
	ld	-8 (ix),h
	ld	a,#0x0E
	...
	inc	hl
	ld	(hl),d
;demo.c:990: cmd.data = 0;
	ld	de,#_cmd + 12
	ld	a,#0x00
	ld	(de),a
;demo.c:991: cmd.argument = 0x00; // from 70xY to left
	ld	de,#_cmd + 13
	ld	a,#0x00
	ld	(de),a
;demo.c:992: cmd.command = 0x98; // vram to vram, y only
	ld	de,#_cmd + 14
	ld	a,#0x98
	ld	(de),a
;demo.c:994: cmd.source_x = twelvetimes[px];
	ld	e,-4 (ix)
	ld	d,-3 (ix)
	sla	e
	rl	d
	...
	inc	hl
	ld	(hl),d
;demo.c:995: cmd.source_y = 768+183+ 16-px;
	inc	hl
	ld	-9 (ix),l
	ld	-8 (ix),h
	ld	a,#0xC7
	...
	inc	hl
	ld	(hl),d
;demo.c:996: cmd.dest_x = 84+twelvetimes[x];
	ld	hl,#_cmd + 4
	ld	-9 (ix),l
	ld	-8 (ix),h
	ld	a,-1 (ix)
	...
	inc	hl
	ld	(hl),d
;demo.c:997: cmd.dest_y = 72+bo+(eighttimes[y]+6)+(14-px);
	ld	hl,#_cmd + 6
	ld	-9 (ix),l
	ld	-8 (ix),h
...
;demo.c:983: for (x = 0; x < 6; x+=1) {
	...
	jp	00144$
00147$:
;demo.c:1002: if (buf == -1) vdp_register(2, 0x1F);
	ld	a,(#_buf+0)
	inc	a
	jr	NZ,00202$
	ld	a,(#_buf+1)
...
00203$:
	...
	jr	00127$
00126$:
;demo.c:1003: else vdp_register(2, 0x3F);
	ld	hl,#0x3F02
	push	hl
	call	_vdp_register
	pop	af
...
;demo.c:1008: ffa+=8;
	...
	ret
_thewave_end::
;demo.c:1014: void drawtritile(uint8_t tx, int ty, uint8_t x, uint8_t y) {
;	---------------------------------
...
;demo.c:1018: cmd.dest_y = y;
	...
	inc	hl
	ld	(hl),d
;demo.c:1019: cmd.size_x = 16;
	ld	hl, #_cmd + 8
	ld	(hl),#0x10
	inc	hl
	ld	(hl),#0x00
;demo.c:1020: cmd.size_y = 16;
	ld	hl, #_cmd + 10
	ld	(hl),#0x10
	inc	hl
	ld	(hl),#0x00
;demo.c:1021: cmd.data = 0;
;demo.c:1022: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1023: cmd.command = 0xd0; // HMMM
	ld	a,#0xD0
	ld	(#_cmd + 14),a
;demo.c:1024: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
	...
	ret
_drawtritile_end::
;demo.c:1031: void drawtilescreen(char* tripic) {
;	---------------------------------
...
_drawtilescreen:
	...
	push	af
	dec	sp
;demo.c:1033: if(tilei >= 192) return;
	ld	a,(#_tilei+0)
	sub	a,#0xC0
	ld	a,(#_tilei+1)
	sbc	a,#0x00
	...
	jp	00112$
00102$:
;demo.c:1035: tiletick++;
	ld	iy,#_tiletick
	inc	0 (iy)
;demo.c:1036: if (tiletick > 6) { tiletick = 0;}
	ld	a,#0x06
	ld	iy,#_tiletick
	sub	a,0 (iy)
	jr	NC,00104$
	...
	jr	00118$
00104$:
;demo.c:1037: else return;
	jp	00112$
;demo.c:1038: for (i=0;i<20;i++) {
00118$:
	ld	-1 (ix),#0x00
00108$:
	ld	a,-1 (ix)
	sub	a,#0x14
	jp	NC,00112$
;demo.c:1039: drawtritile(tri_lookup_x[tripic[tilei]],tri_lookup_y[tripic[tilei]],tilex,tiley);
	ld	a,(#_tiley+0)
	ld	-3 (ix),a
	ld	a,(#_tilex+0)
	ld	-2 (ix),a
...
;demo.c:1041: tilei++;
	...
	inc	1 (iy)
00119$:
;demo.c:1042: if (tilex >= 256) {tilex = 0; tiley+=16; return; }
	ld	a,(#_tilex+0)
	sub	a,#0x00
	ld	a,(#_tilex+1)
	sbc	a,#0x01
...
00112$:
	...
	ret
_drawtilescreen_end::
;demo.c:1047: void drawtilescreen_full(char* tripic) {
;	---------------------------------
...
00103$:
	...
	sbc	a,#0x00
	jp	P,00106$
;demo.c:1052: drawtritile(tri_lookup_x[tripic[i]],tri_lookup_y[tripic[i]],x,y);
	ld	a,-4 (ix)
	ld	-8 (ix),a
	ld	a,-2 (ix)
	ld	-7 (ix),a
...
_tritiles:
	...
	add	hl,sp
	ld	sp,hl
;demo.c:1078: if (tri_inited == 0 || tri_inited == 2) {
	xor	a,a
	ld	iy,#_tri_inited
	or	a,0 (iy)
	jr	Z,00106$
	...
	jp	NZ,00107$
00106$:
;demo.c:1080: cmd.size_x = 2;
	ld	hl, #_cmd + 8
	ld	(hl),#0x02
	inc	hl
	ld	(hl),#0x00
;demo.c:1081: cmd.size_y = 78;
	ld	hl, #_cmd + 10
	ld	(hl),#0x4E
	inc	hl
	ld	(hl),#0x00
;demo.c:1082: cmd.data = 0;
;demo.c:1083: cmd.argument = 0x00; // from 70xY to left
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1084: cmd.command = 0xd0; // vram to vram, y only
	ld	a,#0xD0
	ld	(#_cmd + 14),a
;demo.c:1085: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1086: cmd.source_y = 0;
	ld	bc,#_cmd + 2
	ld	l,c
	ld	h,b
	ld	(hl),#0x00
...
;demo.c:1089: waitVB();
		halt 
;demo.c:1090: cmd.dest_y = 256+78;
	ld	de,#_cmd + 6
	ex	de,hl
	ld	(hl),#0x4E
	inc	hl
	ld	(hl),#0x01
;demo.c:1091: cmd.dest_x = 128-x;
	ld	de,#_cmd + 4
	ld	a,#0x80
	sub	a,-2 (ix)
	ld	c,a
...
;demo.c:1092: vdp_copier(&cmd);
	...
	call	_vdp_copier
	pop	af
;demo.c:1093: cmd.dest_y = 0+78;
	ld	hl, #_cmd + 6
	ld	(hl),#0x4E
	inc	hl
	ld	(hl),#0x00
;demo.c:1094: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1095: cmd.dest_y = 256+78;
	ld	hl, #_cmd + 6
	ld	(hl),#0x4E
	inc	hl
	ld	(hl),#0x01
;demo.c:1096: cmd.dest_x = 128+x;
	ld	bc,#_cmd + 4
	ld	a,-2 (ix)
	add	a,#0x80
	ld	e,a
	...
	inc	hl
	ld	(hl),d
;demo.c:1097: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1098: cmd.dest_y = 0+78;
	ld	hl, #_cmd + 6
	ld	(hl),#0x4E
	inc	hl
	ld	(hl),#0x00
...
;demo.c:1103: vdp_load_palette(scratch);
	...
	call	_vdp_load_palette
	pop	af
;demo.c:1105: tri_inited++;
	ld	iy,#_tri_inited
	inc	0 (iy)
;demo.c:1106: vdp_register(9,2); // 50hz,192
	ld	hl,#0x0209
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1110: vdp_register(2, 0x1f);
	ld	hl,#0x1F02
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1111: tick = 0;
	...
	ld	hl,#_tick + 1
	ld	(hl), #0x00
;demo.c:1114: if (tri_inited == 0) vdp_load_palette(boxes_palette);
	xor	a,a
	ld	hl,#_tri_inited + 0
	or	a,(hl)
	jr	NZ,00104$
	...
	jr	00105$
00104$:
;demo.c:1115: else if (tri_inited == 2) { 
	ld	a,(#_tri_inited+0)
	sub	a,#0x02
	jr	NZ,00105$
;demo.c:1116: vdp_load_palette(boxes_palette); 
	...
	call	_vdp_load_palette
	pop	af
;demo.c:1117: triframes = 0; 
	ld	hl,#_triframes + 0
	ld	(hl), #0x00
	ld	hl,#_triframes + 1
	ld	(hl), #0x00
;demo.c:1119: tripal[0] = 4;
	ld	hl,#_tripal
	ld	(hl),#0x04
;demo.c:1120: tripal[1] = 4;
	ld	a,#0x04
	ld	(#_tripal + 1),a
;demo.c:1121: tripal[2] = 3;
	ld	a,#0x03
	ld	(#_tripal + 2),a
;demo.c:1123: tripal[3] = 2;
	ld	a,#0x02
	ld	(#_tripal + 3),a
;demo.c:1124: tripal[4] = 3;
	ld	a,#0x03
	ld	(#_tripal + 4),a
;demo.c:1125: tripal[5] = 4;
	ld	a,#0x04
	ld	(#_tripal + 5),a
;demo.c:1127: tripal[6] = 1;
	ld	a,#0x01
	ld	(#_tripal + 6),a
;demo.c:1128: tripal[7] = 3;
	ld	a,#0x03
	ld	(#_tripal + 7),a
;demo.c:1129: tripal[8] = 1;
	ld	a,#0x01
	ld	(#_tripal + 8),a
00105$:
;demo.c:1132: msx2_palette(15,0,0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x0F
	push	hl
	...
	pop	af
	pop	af
;demo.c:1133: triframes = 1350;
	ld	hl,#_triframes + 0
	ld	(hl), #0x46
	ld	hl,#_triframes + 1
	ld	(hl), #0x05
00107$:
;demo.c:1137: if (tri_inited == 1) triframes++;
	ld	a,(#_tri_inited+0)
	sub	a,#0x01
	jr	NZ,00110$
	ld	iy,#_triframes
...
00225$:
00110$:
;demo.c:1139: if (triframes == 150) { tilei = 0; tilex = 0; tiley = 0; }
	ld	a,(#_triframes+0)
	sub	a,#0x96
	jr	NZ,00226$
	ld	a,(#_triframes+1)
...
00227$:
	...
	ld	(hl), #0x00
00112$:
;demo.c:1140: if (triframes >= 150 && triframes < 300) {
	ld	a,(#_triframes+0)
	sub	a,#0x96
	ld	a,(#_triframes+1)
	sbc	a,#0x00
	...
	sbc	a,#0x01
	jp	P,00114$
;demo.c:1141: drawtilescreen(tri_up);
	ld	hl,#_tri_up
	push	hl
	call	_drawtilescreen
	pop	af
00114$:
;demo.c:1144: if (triframes == 300) { tilei = 0; tilex = 0; tiley = 0; }
	ld	a,(#_triframes+0)
	sub	a,#0x2C
	jr	NZ,00228$
	ld	a,(#_triframes+1)
...
00229$:
	...
	ld	(hl), #0x00
00117$:
;demo.c:1145: if (triframes >= 300 && triframes < 450) {
	ld	a,(#_triframes+0)
	sub	a,#0x2C
	ld	a,(#_triframes+1)
	sbc	a,#0x01
	...
	sbc	a,#0x01
	jp	P,00119$
;demo.c:1146: drawtilescreen(tri_dia);
	ld	hl,#_tri_dia
	push	hl
	call	_drawtilescreen
	pop	af
00119$:
;demo.c:1149: if (triframes == 450) { tilei = 0; tilex = 0; tiley = 0; }
	ld	a,(#_triframes+0)
	sub	a,#0xC2
	jr	NZ,00230$
	ld	a,(#_triframes+1)
...
00231$:
	...
	ld	(hl), #0x00
00122$:
;demo.c:1150: if (triframes >= 450 && triframes < 600) {
	ld	a,(#_triframes+0)
	sub	a,#0xC2
	ld	a,(#_triframes+1)
	sbc	a,#0x01
	...
	sbc	a,#0x02
	jp	P,00124$
;demo.c:1151: drawtilescreen(tri_side1);
	ld	hl,#_tri_side1
	push	hl
	call	_drawtilescreen
	pop	af
00124$:
;demo.c:1154: if (triframes == 600) { tilei = 0; tilex = 0; tiley = 0; }
	ld	a,(#_triframes+0)
	sub	a,#0x58
	jr	NZ,00232$
	ld	a,(#_triframes+1)
...
00233$:
	...
	ld	(hl), #0x00
00127$:
;demo.c:1155: if (triframes >= 600 && triframes < 750) {
	ld	a,(#_triframes+0)
	sub	a,#0x58
	ld	a,(#_triframes+1)
	sbc	a,#0x02
	...
	sbc	a,#0x02
	jp	P,00129$
;demo.c:1156: drawtilescreen(tri_side2);
	ld	hl,#_tri_side2
	push	hl
	call	_drawtilescreen
	pop	af
00129$:
;demo.c:1159: if (triframes == 750) { tilei = 0; tilex = 0; tiley = 0; }
	ld	a,(#_triframes+0)
	sub	a,#0xEE
	jr	NZ,00234$
	ld	a,(#_triframes+1)
...
00235$:
	...
	ld	(hl), #0x00
00132$:
;demo.c:1160: if (triframes >= 750 && triframes < 900) {
	ld	a,(#_triframes+0)
	sub	a,#0xEE
	ld	a,(#_triframes+1)
	sbc	a,#0x02
	...
	sbc	a,#0x03
	jp	P,00134$
;demo.c:1161: drawtilescreen(tri_inva1);
	ld	hl,#_tri_inva1
	push	hl
	call	_drawtilescreen
	pop	af
00134$:
;demo.c:1164: if (triframes == 900) { tilei = 0; tilex = 0; tiley = 0; }
	ld	a,(#_triframes+0)
	sub	a,#0x84
	jr	NZ,00236$
	ld	a,(#_triframes+1)
...
00237$:
	...
	ld	(hl), #0x00
00137$:
;demo.c:1165: if (triframes >= 900 && triframes < 1050) {
	ld	a,(#_triframes+0)
	sub	a,#0x84
	ld	a,(#_triframes+1)
	sbc	a,#0x03
	...
	sbc	a,#0x04
	jp	P,00139$
;demo.c:1166: drawtilescreen(tri_inva2);
	ld	hl,#_tri_inva2
	push	hl
	call	_drawtilescreen
	pop	af
00139$:
;demo.c:1169: if (triframes == 1050) { tilei = 0; tilex = 0; tiley = 0; }
	ld	a,(#_triframes+0)
	sub	a,#0x1A
	jr	NZ,00238$
	ld	a,(#_triframes+1)
...
00239$:
	...
	ld	(hl), #0x00
00142$:
;demo.c:1170: if (triframes >= 1050 && triframes < 1200) {
	ld	a,(#_triframes+0)
	sub	a,#0x1A
	ld	a,(#_triframes+1)
	sbc	a,#0x04
	...
	sbc	a,#0x04
	jp	P,00144$
;demo.c:1171: drawtilescreen(tri_inva3);
	ld	hl,#_tri_inva3
	push	hl
	call	_drawtilescreen
	pop	af
00144$:
;demo.c:1174: if (triframes == 1200) { tilei = 0; tilex = 0; tiley = 0; }
	ld	a,(#_triframes+0)
	sub	a,#0xB0
	jr	NZ,00240$
	ld	a,(#_triframes+1)
...
00241$:
	...
	ld	(hl), #0x00
00147$:
;demo.c:1175: if (triframes >= 1200 && triframes < 1350) {
	ld	a,(#_triframes+0)
	sub	a,#0xB0
	ld	a,(#_triframes+1)
	sbc	a,#0x04
	...
	sbc	a,#0x05
	jp	P,00149$
;demo.c:1176: drawtilescreen(tri_inva4);
	ld	hl,#_tri_inva4
	push	hl
	call	_drawtilescreen
	pop	af
00149$:
;demo.c:1179: if (triframes == 1350) { tilei = 0; tilex = 0; tiley = 0; }
	ld	a,(#_triframes+0)
	sub	a,#0x46
	jr	NZ,00242$
	ld	a,(#_triframes+1)
...
00243$:
	...
	ld	(hl), #0x00
00152$:
;demo.c:1180: if (triframes >= 1350 && triframes < 1500) {
	ld	a,(#_triframes+0)
	sub	a,#0x46
	ld	a,(#_triframes+1)
	sbc	a,#0x05
	...
	sbc	a,#0x05
	jp	P,00154$
;demo.c:1181: drawtilescreen(tri_center);
	ld	hl,#_tri_center
	push	hl
	call	_drawtilescreen
	pop	af
00154$:
;demo.c:1184: if (triframes > 1500) triframes = 149;
	ld	a,#0xDC
	ld	iy,#_triframes
	sub	a,0 (iy)
	ld	a,#0x05
	...
	ld	(hl), #0x00
00157$:
;demo.c:1187: msx2_palette(2,0,0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x02
	push	hl
	...
	pop	af
	pop	af
;demo.c:1188: msx2_palette(11,0,0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x0B
	push	hl
	...
	pop	af
	pop	af
;demo.c:1190: if (PLY_PSGReg10 > 4) {
	ld	a,#0x04
	ld	iy,#_PLY_PSGReg10
	sub	a,0 (iy)
	jp	NC,00159$
;demo.c:1191: vdp_register(VDP_VOFFSET,192-sintabx[(PLY_PSGReg10 + tripaltick) & 255]>>3);
	...
	call	_vdp_register
	pop	af
;demo.c:1193: msx2_palette(3,tripal[0]+PLY_PSGReg10,tripal[1],tripal[2]);
	ld	hl,#_tripal + 2
	ld	c,(hl)
	ld	de,#_tripal + 1
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:1194: msx2_palette(14,tripal[3],tripal[4],tripal[5]);
	ld	hl,#_tripal + 5
	ld	c,(hl)
	ld	de,#_tripal + 4
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:1195: msx2_palette(6,tripal[6],tripal[7],tripal[8]);
	ld	hl,#_tripal + 8
	ld	c,(hl)
	ld	de,#_tripal + 7
	ld	a,(de)
	...
	jp	00160$
00159$:
;demo.c:1198: vdp_register(VDP_VOFFSET,0);
	ld	hl,#0x0017
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1200: msx2_palette(3,tripal[0],tripal[1],tripal[2]);
	ld	hl,#_tripal + 2
	ld	c,(hl)
	ld	de,#_tripal + 1
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:1201: msx2_palette(14,tripal[3],tripal[4],tripal[5]);
	ld	hl,#_tripal + 5
	ld	c,(hl)
	ld	de,#_tripal + 4
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:1202: msx2_palette(6,tripal[6],tripal[7],tripal[8]);
	ld	hl,#_tripal + 8
	ld	c,(hl)
	ld	de,#_tripal + 7
	ld	a,(de)
...
;demo.c:1206: if (tick > 28) tick = 0;
	...
	ld	(hl), #0x00
00162$:
;demo.c:1208: tripaltick++;
	ld	iy,#_tripaltick
	inc	0 (iy)
;demo.c:1209: if (tripaltick > 6) {
	ld	a,#0x06
	ld	iy,#_tripaltick
	sub	a,0 (iy)
	jp	NC,00175$
;demo.c:1210: tripaltick2++;
	ld	iy,#_tripaltick2
	inc	0 (iy)
;demo.c:1211: if (tripaltick2 > 6) tripaltick2 = 0;
	ld	a,#0x06
	ld	iy,#_tripaltick2
	sub	a,0 (iy)
	jr	NC,00164$
	...
	ld	(hl), #0x00
00164$:
;demo.c:1213: r = tripal[0];
	ld	hl,#_tripal
	ld	c,(hl)
	ld	-3 (ix),c
;demo.c:1214: g = tripal[1];
	ld	de,#_tripal + 1
	ld	a,(de)
	ld	-4 (ix),a
;demo.c:1215: b = tripal[2];
	ld	hl,#_tripal + 2
	ld	e,(hl)
	ld	-5 (ix),e
;demo.c:1217: for (x = 0; x < 6; x++) {
	ld	-2 (ix),#0x00
	ld	-1 (ix),#0x00
00171$:
	ld	a,-2 (ix)
	...
	sbc	a,#0x00
	jp	P,00174$
;demo.c:1218: tripal[x] = tripal[x+3];
	ld	a,#<_tripal
	add	a,-2 (ix)
	ld	c,a
	ld	a,#>_tripal
...
00245$:
	jr	00171$
00174$:
;demo.c:1221: tripal[6] = r;
	ld	bc,#_tripal + 6
	ld	a,-3 (ix)
	ld	(bc),a
;demo.c:1222: tripal[7] = g;
	ld	bc,#_tripal + 7
	ld	a,-4 (ix)
	ld	(bc),a
;demo.c:1223: tripal[8] = b;
	ld	bc,#_tripal + 8
	ld	a,-5 (ix)
	ld	(bc),a
;demo.c:1224: tripaltick = 0;
	ld	hl,#_tripaltick + 0
	ld	(hl), #0x00
00175$:
	ld	sp,ix
...
_abs:
	...
	add	hl,sp
	ld	sp,hl
;demo.c:1230: const int ret[2] = { n, -n };
	ld	hl,#0x0002
	add	hl,sp
	ld	c,l
	ld	b,h
...
;demo.c:1241: fadein();
	call	_fadein
;demo.c:1243: v = abs(sintabx[(vbicount) & 255]>>4);
	ld	hl,#_vbicount + 0
	ld	c,(hl)
	ld	b,#0x00
	ld	hl,#_sintabx
...
00108$:
	...
	sbc	a,#0x00
	jp	P,00111$
;demo.c:1246: cmd.size_x = 108;
	ld	de,#_cmd + 8
	ex	de,hl
	ld	(hl),#0x6C
	inc	hl
	ld	(hl),#0x00
;demo.c:1247: cmd.size_y = 2;
	ld	de,#_cmd + 10
	ex	de,hl
	ld	(hl),#0x02
	inc	hl
	ld	(hl),#0x00
;demo.c:1248: cmd.data = 0;
	ld	de,#_cmd + 12
	ld	a,#0x00
	ld	(de),a
;demo.c:1249: cmd.argument = 0x00;
	ld	de,#_cmd + 13
	ld	a,#0x00
	ld	(de),a
;demo.c:1250: cmd.command = 0xd0; 
	ld	de,#_cmd + 14
	ld	a,#0xD0
	ld	(de),a
;demo.c:1251: cmd.source_x = 74;
	ld	hl,#_cmd
	ld	(hl),#0x4A
	inc	hl
	ld	(hl),#0x00
;demo.c:1252: cmd.source_y = 256+y;
	ld	de,#_cmd + 2
	ld	a,-2 (ix)
	add	a,#0x00
	ld	c,a
...
;demo.c:1245: for (y = 0; y < 116; y+=2) {
	...
	jp	00108$
00111$:
;demo.c:1262: if (vbicount > scenetimings[2]+84 && onceclear > 182) {
	...
	sub	a,0 (iy)
	jp	NC,00106$
;demo.c:1263: cmd.size_x = 4;
	ld	hl, #_cmd + 8
	ld	(hl),#0x04
	inc	hl
	ld	(hl),#0x00
;demo.c:1264: cmd.size_y = 116;
	ld	hl, #_cmd + 10
	ld	(hl),#0x74
	inc	hl
	ld	(hl),#0x00
;demo.c:1265: cmd.data = 0;
;demo.c:1266: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1267: cmd.command = 0xd0; 
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1268: cmd.source_x = 20;
	ld	hl,#_cmd
	ld	(hl),#0x14
	inc	hl
	ld	(hl),#0x00
;demo.c:1269: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1270: cmd.dest_x = onceclear;
	ld	bc,#_cmd + 4
	ld	hl,#_onceclear + 0
	ld	e,(hl)
	ld	d,#0x00
...
_points:
	...
	push	af
	dec	sp
;demo.c:1291: if (initpoints == 0) {
	xor	a,a
	ld	hl,#_initpoints + 0
	or	a,(hl)
	jp	NZ,00105$
;demo.c:1292: cmd.size_x = 256;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1293: cmd.size_y = 4;
	ld	hl, #_cmd + 10
	ld	(hl),#0x04
	inc	hl
	ld	(hl),#0x00
;demo.c:1294: cmd.data = 0;
;demo.c:1295: cmd.argument = 0x00; // from 70xY to left
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1296: cmd.command = 0xd0; // vram to vram, y only
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1297: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1298: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1300: for (y = 0; y < 212; y+=4) {
	ld	-1 (ix),#0x00
00116$:
	ld	a,-1 (ix)
	sub	a,#0xD4
	jp	NC,00119$
;demo.c:1301: if (PLY_PSGReg10 > 4) {
	ld	a,#0x04
	ld	iy,#_PLY_PSGReg10
	sub	a,0 (iy)
	jp	NC,00102$
;demo.c:1302: vdp_register(VDP_VOFFSET,192-sintabx[(PLY_PSGReg10 + tripaltick) & 255]>>3);
	ld	hl,#_PLY_PSGReg10 + 0
	ld	e,(hl)
	ld	d,#0x00
	ld	hl,#_tripaltick + 0
	...
	call	_vdp_register
	pop	af
;demo.c:1304: msx2_palette(3,tripal[0]+PLY_PSGReg10,tripal[1],tripal[2]);
	ld	hl,#_tripal + 2
	ld	c,(hl)
	ld	de,#_tripal + 1
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:1305: msx2_palette(14,tripal[3],tripal[4],tripal[5]);
	ld	hl,#_tripal + 5
	ld	c,(hl)
	ld	de,#_tripal + 4
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:1306: msx2_palette(6,tripal[6],tripal[7],tripal[8]);
	ld	hl,#_tripal + 8
	ld	c,(hl)
	ld	de,#_tripal + 7
	ld	a,(de)
	...
	jp	00103$
00102$:
;demo.c:1309: vdp_register(VDP_VOFFSET,0);
	ld	hl,#0x0017
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1311: msx2_palette(3,tripal[0],tripal[1],tripal[2]);
	ld	hl,#_tripal + 2
	ld	c,(hl)
	ld	de,#_tripal + 1
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:1312: msx2_palette(14,tripal[3],tripal[4],tripal[5]);
	ld	hl,#_tripal + 5
	ld	c,(hl)
	ld	de,#_tripal + 4
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:1313: msx2_palette(6,tripal[6],tripal[7],tripal[8]);
	ld	hl,#_tripal + 8
	ld	c,(hl)
	ld	de,#_tripal + 7
	ld	a,(de)
...
;demo.c:1316: waitVB();
		halt 
;demo.c:1317: cmd.source_y = 193;
	ld	hl, #_cmd + 2
	ld	(hl),#0xC1
	inc	hl
	ld	(hl),#0x00
;demo.c:1318: cmd.dest_y = y;
	ld	bc,#_cmd + 6
	ld	e,-1 (ix)
	ld	d,#0x00
	ld	l,c
...
;demo.c:1300: for (y = 0; y < 212; y+=4) {
	...
	jp	00116$
00119$:
;demo.c:1323: vdp_load_palette(bulbs_palette);
	ld	hl,#_bulbs_palette
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1325: for (x = 0; x < 256; x+=1) {
	ld	-3 (ix),#0x00
	ld	-2 (ix),#0x00
00120$:
	ld	a,-3 (ix)
	...
	sbc	a,#0x01
	jp	P,00123$
;demo.c:1327: cmd.data = 1+((pointframe>>2) & 0xe);
	ld	de,#_cmd + 12
	ld	hl,#_pointframe + 0
	ld	c,(hl)
	ld	hl,#_pointframe + 1
...
;demo.c:1328: cmd.dest_x = x;
	...
	ld	a,-2 (ix)
	ld	(hl),a
;demo.c:1329: cmd.dest_y = y;
	ld	hl, #_cmd + 6
	ld	(hl),#0x1D
	inc	hl
	ld	(hl),#0x00
;demo.c:1330: cmd.command = 0x50;
	ld	a,#0x50
	ld	(#_cmd + 14),a
;demo.c:1331: vdp_copier(&cmd);
	...
	call	_vdp_copier
	pop	af
;demo.c:1334: cmd.data = 1+((pointframe>>2) & 0xe);
	ld	bc,#_cmd + 12
	ld	hl,#_pointframe + 0
	ld	e,(hl)
	ld	hl,#_pointframe + 1
	...
	inc	a
	ld	(bc),a
;demo.c:1335: cmd.dest_y = y;
	ld	hl, #_cmd + 6
	ld	(hl),#0xA2
	inc	hl
	ld	(hl),#0x00
;demo.c:1336: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1338: pointframe+=1;
	ld	iy,#_pointframe
	inc	0 (iy)
	jr	NZ,00149$
	ld	iy,#_pointframe
...
00150$:
	jp	00120$
00123$:
;demo.c:1341: initpoints = 1;
	ld	hl,#_initpoints + 0
	ld	(hl), #0x01
;demo.c:1342: ltrpointer = 0;
	ld	hl,#_ltrpointer + 0
	ld	(hl), #0x00
	ld	hl,#_ltrpointer + 1
	ld	(hl), #0x00
00105$:
;demo.c:1345: cmd.argument = 0x0;
	ld	a,#0x00
	ld	(#_cmd + 13),a
;demo.c:1347: cmd.data = 1+((pointframe>>2) & 0xe);
	...
	inc	a
	ld	(bc),a
;demo.c:1349: for (x = 30; x < 162; x+=1) {
	ld	-3 (ix),#0x1E
	ld	-2 (ix),#0x00
00124$:
	ld	a,-3 (ix)
	...
	sbc	a,#0x00
	jp	P,00127$
;demo.c:1350: y = 64+(sintabx[(x+pointframe) & 255]>>1);
	ld	hl,#_pointframe
	ld	a,-3 (ix)
	add	a,(hl)
	ld	e,a
...
;demo.c:1352: cmd.dest_y = x;
	...
	ld	a,-2 (ix)
	ld	(hl),a
;demo.c:1353: cmd.command = 0x53;
	ld	a,#0x53
	ld	(#_cmd + 14),a
;demo.c:1354: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
...
;demo.c:1356: pointframe+=2;
	...
	inc	hl
	ld	(hl),a
;demo.c:1358: if (greetindex == 0) {
	ld	a,(#_greetindex+0)
	ld	hl,#_greetindex + 1
	or	a,(hl)
	jr	NZ,00107$
;demo.c:1359: slowend = 27;
	ld	hl,#_slowend + 0
	ld	(hl), #0x1B
	ld	hl,#_slowend + 1
	ld	(hl), #0x00
;demo.c:1360: drawstrslow("GREETINGS TO VARIOUS GROUPS",10,20);
	ld	hl,#0x140A
	push	hl
	ld	hl,#__str_9
	push	hl
...
00153$:
	jr	00109$
00154$:
;demo.c:1363: slowend = 33;
	ld	hl,#_slowend + 0
	ld	(hl), #0x21
	ld	hl,#_slowend + 1
	ld	(hl), #0x00
;demo.c:1364: drawstrslow("Trilobit  Prismbeings  Ivory Labs",10,164);
	ld	hl,#0xA40A
	push	hl
	ld	hl,#__str_10
	push	hl
...
00155$:
	jr	00111$
00156$:
;demo.c:1367: slowend = 29;
	ld	hl,#_slowend + 0
	ld	(hl), #0x1D
	ld	hl,#_slowend + 1
	ld	(hl), #0x00
;demo.c:1368: drawstrslow("PWP  Dekadence  Paraguay  ISO",18,174);
	ld	hl,#0xAE12
	push	hl
	ld	hl,#__str_11
	push	hl
...
00157$:
	jr	00113$
00158$:
;demo.c:1371: slowend = 17;
	ld	hl,#_slowend + 0
	ld	(hl), #0x11
	ld	hl,#_slowend + 1
	ld	(hl), #0x00
;demo.c:1372: drawstrslow("Furry Trash Group",26,184);
	ld	hl,#0xB81A
	push	hl
	ld	hl,#__str_12
	push	hl
	...
	pop	af
00113$:
;demo.c:1374: if (ltrpointer >= slowend) { greetindex++; ltrpointer = 0; }
	ld	hl,#_slowend
	ld	a,(#_ltrpointer+0)
	sub	a,(hl)
	ld	a,(#_ltrpointer+1)
...
00159$:
	...
	ld	(hl), #0x00
00115$:
;demo.c:1376: msx2_palette(4,0,0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x04
	push	hl
...
_bigtext:
	...
	add	ix,sp
	push	af
;demo.c:1382: if (bigtextp == 0) {
	ld	a,(#_bigtextp+0)
	ld	iy,#_bigtextp
	or	a,1 (iy)
	jp	NZ,00102$
;demo.c:1383: cmd.size_x = 2;
	ld	hl, #_cmd + 8
	ld	(hl),#0x02
	inc	hl
	ld	(hl),#0x00
;demo.c:1384: cmd.size_y = 212;
	ld	hl, #_cmd + 10
	ld	(hl),#0xD4
	inc	hl
	ld	(hl),#0x00
;demo.c:1385: cmd.data = 0;
;demo.c:1386: cmd.argument = 0x00; // from 70xY to left
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1387: cmd.command = 0xd0; // vram to vram, y only
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1388: cmd.source_x = 255;
	ld	hl,#_cmd
	ld	(hl),#0xFF
	inc	hl
	ld	(hl),#0x00
;demo.c:1389: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1391: for (x = 0; x < 256; x+=4) {
	ld	bc,#0x0000
00128$:
	ld	a,c
	sub	a,#0x00
...
;demo.c:1401: waitVB();
		halt 
;demo.c:1402: cmd.dest_y = 256;
	ld	de,#_cmd + 6
	ex	de,hl
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1403: cmd.dest_x = x;
	ld	de,#_cmd + 4
	ex	de,hl
	ld	(hl),c
	inc	hl
...
;demo.c:1404: vdp_copier(&cmd);
	...
	pop	af
	pop	bc
;demo.c:1405: cmd.dest_y = 0;
	ld	de,#_cmd + 6
	ex	de,hl
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1406: vdp_copier(&cmd);
	push	bc
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
...
;demo.c:1409: bigtextp++;
	...
	inc	1 (iy)
00188$:
;demo.c:1410: vdp_load_palette(boxes_palette);
	ld	hl,#_boxes_palette
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1411: drawstr2x("DIGITAL",26,44);
	ld	hl,#0x2C1A
	push	hl
	ld	hl,#__str_13
	push	hl
	...
	pop	af
	pop	af
;demo.c:1412: drawstr2x("SOUNDS",27,84);
	ld	hl,#0x541B
	push	hl
	ld	hl,#__str_14
	push	hl
	...
	pop	af
	pop	af
;demo.c:1413: drawstr2x("SYSTEM",25,124);
	ld	hl,#0x7C19
	push	hl
	ld	hl,#__str_15
	push	hl
...
;demo.c:1416: ff = 0;
	...
	ld	hl,#_ff + 1
	ld	(hl), #0x00
;demo.c:1417: ltrpointer = 0;
	ld	hl,#_ltrpointer + 0
	ld	(hl), #0x00
	ld	hl,#_ltrpointer + 1
	ld	(hl), #0x00
00102$:
;demo.c:1420: msx2_palette(4,ff>>2,ff>>3,ff>>2);
	ld	hl,#_ff + 0
	ld	c,(hl)
	ld	hl,#_ff + 1
	ld	b,(hl)
...
00191$:
	jp	00104$
00192$:
;demo.c:1424: cmd.size_x = 256;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1425: cmd.size_y = 3;
	ld	hl, #_cmd + 10
	ld	(hl),#0x03
	inc	hl
	ld	(hl),#0x00
;demo.c:1426: cmd.data = 0;
;demo.c:1427: cmd.argument = 0x00; // from 70xY to left
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1428: cmd.command = 0xd0; // vram to vram, y only
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1429: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1430: cmd.source_y = 28;
	ld	hl, #_cmd + 2
	ld	(hl),#0x1C
	inc	hl
	ld	(hl),#0x00
;demo.c:1432: cmd.dest_y = 512;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x02
;demo.c:1433: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1434: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1436: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1437: cmd.source_y = 512;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x02
...
00136$:
	...
	sbc	a,#0x00
	jp	P,00139$
;demo.c:1440: msx2_palette(4,ff>>2,ff>>3,ff>>2);
	ld	hl,#_ff + 0
	ld	e,(hl)
	ld	hl,#_ff + 1
	ld	d,(hl)
...
;demo.c:1447: cmd.dest_y = 161-x;
	...
	inc	hl
	ld	(hl),d
;demo.c:1448: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1449: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
...
;demo.c:1456: waitVB();
		halt 
;demo.c:1457: cmd.dest_y = 28+66-x;
	ld	bc,#_cmd + 6
	ld	a,#0x5E
	sub	a,-2 (ix)
	ld	e,a
...
;demo.c:1459: vdp_copier(&cmd);
	...
	call	_vdp_copier
	pop	af
;demo.c:1460: cmd.dest_y = 161-66+x;
	ld	bc,#_cmd + 6
	ld	a,-2 (ix)
	add	a,#0x5F
	ld	e,a
...
00198$:
	jp	00140$
00143$:
;demo.c:1466: drawstr2x("COMMAND",4,44);
	ld	hl,#0x2C04
	push	hl
	ld	hl,#__str_16
	push	hl
	...
	pop	af
	pop	af
;demo.c:1467: drawstr2x("   THE  ",32,84);
	ld	hl,#0x5420
	push	hl
	ld	hl,#__str_17
	push	hl
	...
	pop	af
	pop	af
;demo.c:1468: drawstr2x("  BASS ",35,124);
	ld	hl,#0x7C23
	push	hl
	ld	hl,#__str_18
	push	hl
...
00199$:
	jp	00106$
00200$:
;demo.c:1472: cmd.size_x = 3;
	ld	hl, #_cmd + 8
	ld	(hl),#0x03
	inc	hl
	ld	(hl),#0x00
;demo.c:1473: cmd.size_y = 212;
	ld	hl, #_cmd + 10
	ld	(hl),#0xD4
	inc	hl
	ld	(hl),#0x00
;demo.c:1474: cmd.data = 0;
;demo.c:1475: cmd.argument = 0x00; // from 70xY to left
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1476: cmd.command = 0xd0; // vram to vram, y only
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1477: cmd.source_x = 255;
	ld	hl,#_cmd
	ld	(hl),#0xFF
	inc	hl
	ld	(hl),#0x00
;demo.c:1478: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1480: for (x = 254; x > 0; x-=4) {
	ld	-2 (ix),#0xFE
	ld	-1 (ix),#0x00
00144$:
	ld	a,#0x00
	...
	sbc	a,-1 (ix)
	jp	P,00147$
;demo.c:1481: msx2_palette(4,ff>>2,ff>>3,ff>>2);
	ld	hl,#_ff + 0
	ld	e,(hl)
	ld	hl,#_ff + 1
	ld	d,(hl)
...
;demo.c:1483: waitVB();
		halt 
;demo.c:1484: cmd.dest_y = 256;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1485: cmd.dest_x = x;
	ld	hl, #_cmd + 4
	ld	a,-2 (ix)
	ld	(hl),a
	inc	hl
	ld	a,-1 (ix)
	ld	(hl),a
;demo.c:1486: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1487: cmd.dest_y = 0;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
...
00148$:
	...
	sbc	a,#0x01
	jp	P,00151$
;demo.c:1493: msx2_palette(4,ff>>2,ff>>3,ff>>2);
	ld	hl,#_ff + 0
	ld	e,(hl)
	ld	hl,#_ff + 1
	ld	d,(hl)
...
;demo.c:1495: waitVB();
		halt 
;demo.c:1496: cmd.dest_y = 256;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1497: cmd.dest_x = x;
	ld	hl, #_cmd + 4
	ld	a,-2 (ix)
	ld	(hl),a
	inc	hl
	ld	a,-1 (ix)
	ld	(hl),a
;demo.c:1498: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1499: cmd.dest_y = 0;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1500: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1492: for (x = 0; x < 256; x+=4) {
	...
	jp	00148$
00151$:
;demo.c:1503: drawstr2x("REVISION",10,44);
	ld	hl,#0x2C0A
	push	hl
	ld	hl,#__str_19
	push	hl
	...
	pop	af
	pop	af
;demo.c:1504: drawstr2x("   IS OUR",0,84);
	ld	hl,#0x5400
	push	hl
	ld	hl,#__str_20
	push	hl
	...
	pop	af
	pop	af
;demo.c:1505: drawstr2x("  PARTY",12,124);
	ld	hl,#0x7C0C
	push	hl
	ld	hl,#__str_21
	push	hl
	...
	pop	af
00106$:
;demo.c:1508: if (ff >= 1600 && ff < 1700) {
	ld	a,(#_ff+0)
	sub	a,#0x40
	ld	a,(#_ff+1)
	sbc	a,#0x06
	...
	sbc	a,#0x06
	jp	P,00108$
;demo.c:1509: slowend = 37;
	ld	hl,#_slowend + 0
	ld	(hl), #0x25
	ld	hl,#_slowend + 1
	ld	(hl), #0x00
;demo.c:1510: drawstrslow("Give a big hand to all the organizers",28,164+6);
	ld	hl,#0xAA1C
	push	hl
	ld	hl,#__str_22
	push	hl
...
00205$:
	jr	00111$
00206$:
;demo.c:1514: ltrpointer = 0;
	ld	hl,#_ltrpointer + 0
	ld	(hl), #0x00
	ld	hl,#_ltrpointer + 1
	ld	(hl), #0x00
00111$:
;demo.c:1517: if (ff > 1700 && ff < 1800) {
	ld	a,#0xA4
	ld	iy,#_ff
	sub	a,0 (iy)
	ld	a,#0x06
	...
	sbc	a,#0x07
	jp	P,00113$
;demo.c:1518: slowend = 21;
	ld	hl,#_slowend + 0
	ld	(hl), #0x15
	ld	hl,#_slowend + 1
	ld	(hl), #0x00
;demo.c:1519: drawstrslow("of this amazing party",64,164+16);
	ld	hl,#0xB440
	push	hl
	ld	hl,#__str_23
	push	hl
	...
	pop	af
00113$:
;demo.c:1522: if (ff >= 1900 && ff < 3890) {
	ld	a,(#_ff+0)
	sub	a,#0x6C
	ld	a,(#_ff+1)
	sbc	a,#0x07
	...
	sbc	a,#0x0F
	jp	P,00116$
;demo.c:1523: cmd.size_x = 1;
	ld	hl, #_cmd + 8
	ld	(hl),#0x01
	inc	hl
	ld	(hl),#0x00
;demo.c:1524: cmd.size_y = 17;
	ld	hl, #_cmd + 10
	ld	(hl),#0x11
	inc	hl
	ld	(hl),#0x00
;demo.c:1525: cmd.data = 0;
;demo.c:1526: cmd.argument = 0x00; // from 70xY to left
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1527: cmd.command = 0xd0; // vram to vram, y only
	ld	a,#0xD0
	ld	(#_cmd + 14),a
;demo.c:1528: cmd.source_x = 128+20*(((ff-1901)>>3) % 6);
	ld	a,(#_ff+0)
	add	a,#0x93
	ld	c,a
	ld	a,(#_ff+1)
	...
	inc	hl
	ld	(hl),b
;demo.c:1529: cmd.source_y = 768+30;
	ld	hl, #_cmd + 2
	ld	(hl),#0x1E
	inc	hl
	ld	(hl),#0x03
;demo.c:1530: cmd.dest_x = (255)-((ff-1900)>>3);
	ld	bc,#_cmd + 4
	ld	a,(#_ff+0)
	add	a,#0x94
	ld	e,a
	...
	inc	hl
	ld	(hl),d
;demo.c:1531: cmd.dest_y = 12;
	ld	hl, #_cmd + 6
	ld	(hl),#0x0C
	inc	hl
	ld	(hl),#0x00
;demo.c:1532: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1535: cmd.size_x = 20;
	ld	hl, #_cmd + 8
	ld	(hl),#0x14
	inc	hl
	ld	(hl),#0x00
;demo.c:1536: cmd.size_y = 17;
	ld	hl, #_cmd + 10
	ld	(hl),#0x11
	inc	hl
	ld	(hl),#0x00
;demo.c:1537: cmd.data = 0;
;demo.c:1538: cmd.argument = 0x00; // from 70xY to left
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1539: cmd.command = 0xd0; // vram to vram, y only
	ld	a,#0xD0
	ld	(#_cmd + 14),a
;demo.c:1540: cmd.source_x = 128+20*(((ff-1900)>>3) % 6);
	ld	a,(#_ff+0)
	add	a,#0x94
	ld	c,a
	ld	a,(#_ff+1)
	...
	inc	hl
	ld	(hl),d
;demo.c:1541: cmd.source_y = 768;
	ld	de,#_cmd + 2
	ex	de,hl
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x03
;demo.c:1542: cmd.dest_x = (256-20)-((ff-1900)>>3);
	ld	de,#_cmd + 4
	ld	a,#0xEC
	sub	a,c
	ld	c,a
	...
	inc	hl
	ld	(hl),b
;demo.c:1543: cmd.dest_y = 12;
	ld	hl, #_cmd + 6
	ld	(hl),#0x0C
	inc	hl
	ld	(hl),#0x00
;demo.c:1544: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
00116$:
;demo.c:1549: if (ff == 2700) {
	ld	a,(#_ff+0)
	sub	a,#0x8C
	jr	NZ,00210$
	ld	a,(#_ff+1)
...
00210$:
	jr	00119$
00211$:
;demo.c:1550: ltrpointer = 0;
	ld	hl,#_ltrpointer + 0
	ld	(hl), #0x00
	ld	hl,#_ltrpointer + 1
	ld	(hl), #0x00
00119$:
;demo.c:1553: if (ff > 2700 && ff < 2800) {
	ld	a,#0x8C
	ld	iy,#_ff
	sub	a,0 (iy)
	ld	a,#0x0A
	...
	sbc	a,#0x0A
	jp	P,00121$
;demo.c:1554: slowend = 21;
	ld	hl,#_slowend + 0
	ld	(hl), #0x15
	ld	hl,#_slowend + 1
	ld	(hl), #0x00
;demo.c:1555: drawstrslow("Digital Sounds System",0,0);
	ld	hl,#0x0000
	push	hl
	ld	hl,#__str_24
	push	hl
...
00212$:
	jr	00124$
00213$:
;demo.c:1559: ltrpointer = 0;
	ld	hl,#_ltrpointer + 0
	ld	(hl), #0x00
	ld	hl,#_ltrpointer + 1
	ld	(hl), #0x00
00124$:
;demo.c:1562: if (ff > 3200 && ff < 3400) {
	ld	a,#0x80
	ld	iy,#_ff
	sub	a,0 (iy)
	ld	a,#0x0C
	...
	sbc	a,#0x0D
	jp	P,00152$
;demo.c:1563: slowend = 19;
	ld	hl,#_slowend + 0
	ld	(hl), #0x13
	ld	hl,#_slowend + 1
	ld	(hl), #0x00
;demo.c:1564: drawstrslow("mew mew mew miu mou",134,0);
	ld	hl,#0x0086
	push	hl
	ld	hl,#__str_25
	push	hl
...
_credits:
	...
	add	hl,sp
	ld	sp,hl
;demo.c:1585: if (initcredits == 0) {
	ld	a,(#_initcredits+0)
	ld	hl,#_initcredits + 1
	or	a,(hl)
	jp	NZ,00102$
;demo.c:1586: uninstall_isr();
	call	_uninstall_isr
;demo.c:1587: PLY_Stop();
	call	_PLY_Stop
;demo.c:1588: PLY_SendRegisters();
	call	_PLY_SendRegisters
;demo.c:1590: scratch_clear();
	call	_scratch_clear
;demo.c:1591: vdp_load_palette(scratch);
	ld	hl,#_scratch
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1594: vdp_register(9,130); // 50hz,212
	ld	hl,#0x8209
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1596: bitbuster(loading_pck,0x0000,VRAM_0);
	ld	a,#0x01
	push	af
	inc	sp
	ld	hl,#0x0000
...
;demo.c:1609: pause();
	call	_pause
;demo.c:1611: vdp_register(2,0x7f);
	ld	hl,#0x7F02
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1612: vdp_load_palette(boxes_palette);
	ld	hl,#_boxes_palette
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1614: initcredits = 1;
	ld	hl,#_initcredits + 0
	ld	(hl), #0x01
	ld	hl,#_initcredits + 1
	ld	(hl), #0x00
;demo.c:1616: raw_load("CREDIT2 PCK", 4724, packbuffer,0);
	ld	hl,#0x0000
	push	hl
	ld	hl,#_packbuffer
	push	hl
	...
	pop	af
	pop	af
;demo.c:1618: bitbuster(packbuffer,0x0000,VRAM_0);
	ld	a,#0x01
	push	af
	inc	sp
	ld	hl,#0x0000
	...
	pop	af
	inc	sp
;demo.c:1620: cmd.size_x = 512;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x02
;demo.c:1621: cmd.size_y = 212;
	ld	hl, #_cmd + 10
	ld	(hl),#0xD4
	inc	hl
	ld	(hl),#0x00
;demo.c:1622: cmd.data = 0;
;demo.c:1623: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1624: cmd.command = 0xd0; 
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1625: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1626: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1627: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1628: cmd.dest_y = 256;
	...
	inc	hl
	ld	(hl),#0x01
;demo.c:1629: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1631: raw_load("CREDIT3 PCK", 3723, packbuffer,0);
	ld	hl,#0x0000
	push	hl
	ld	hl,#_packbuffer
	push	hl
	...
	pop	af
	pop	af
;demo.c:1633: bitbuster(packbuffer,0x0000,VRAM_0);
	ld	a,#0x01
	push	af
	inc	sp
	ld	hl,#0x0000
...
;demo.c:1644: vdp_copier(&cmd);
	...
	call	_vdp_copier
	pop	af
;demo.c:1646: raw_load("CREDIT1 PCK", 3323, packbuffer,0);
	ld	hl,#0x0000
	push	hl
	ld	hl,#_packbuffer
	push	hl
	...
	pop	af
	pop	af
;demo.c:1648: bitbuster(packbuffer,0x0000,VRAM_0);
	ld	a,#0x01
	push	af
	inc	sp
	ld	hl,#0x0000
	...
	pop	af
	inc	sp
;demo.c:1650: scratch_clear();
	call	_scratch_clear
;demo.c:1651: vdp_load_palette(scratch);
	ld	hl,#_scratch
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1653: vdp_register(0,8); // mode 512x212
	ld	hl,#0x0800
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1654: vdp_register(9,130); // 50hz,192
	ld	hl,#0x8209
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1656: install_isr(my_isr);
	ld	hl,#_my_isr
	push	hl
	call	_install_isr
	pop	af
;demo.c:1658: memcpy(cur_palette, credits_palette, 32);
	ld	hl,#0x0020
	push	hl
	...
	pop	af
	pop	af
;demo.c:1660: scratch_clear();
	call	_scratch_clear
;demo.c:1661: pointframe = 0;
	ld	hl,#_pointframe + 0
	ld	(hl), #0x00
	ld	hl,#_pointframe + 1
	ld	(hl), #0x00
;demo.c:1662: curpage = 0;
	ld	hl,#_curpage + 0
	ld	(hl), #0x00
	ld	hl,#_curpage + 1
	ld	(hl), #0x00
;demo.c:1663: myoffs = 180;
	ld	hl,#_myoffs + 0
	ld	(hl), #0xB4
	ld	hl,#_myoffs + 1
	ld	(hl), #0x00
;demo.c:1664: vdp_register(2,0x1f);
	ld	hl,#0x1F02
	push	hl
	call	_vdp_register
	pop	af
00102$:
;demo.c:1668: if (credittimer < 400) fadein();
	ld	a,(#_credittimer+0)
	sub	a,#0x90
	ld	a,(#_credittimer+1)
	sbc	a,#0x01
	...
	call	_fadein
00104$:
;demo.c:1670: if(credittimer >= 1000 && curpage == 0) { vdp_register(2, 0x3f); curpage = 256; myoffs = 100; }
	ld	a,(#_credittimer+0)
	sub	a,#0xE8
	ld	a,(#_credittimer+1)
	sbc	a,#0x03
	...
	ld	(hl), #0x00
00106$:
;demo.c:1671: if(credittimer >= 1500 && curpage == 256) { vdp_register(2, 0x5f); curpage = 512; myoffs = 200; }
	ld	a,(#_credittimer+0)
	sub	a,#0xDC
	ld	a,(#_credittimer+1)
	sbc	a,#0x05
...
;demo.c:1673: credittimer+=3;
	...
	inc	hl
	ld	(hl),a
;demo.c:1674: if (credittimer == 1500) {
	ld	a,(#_credittimer+0)
	sub	a,#0xDC
	jr	NZ,00142$
	ld	a,(#_credittimer+1)
...
00142$:
	jr	00112$
00143$:
;demo.c:1675: vdp_load_palette(scratch);
	ld	hl,#_scratch
	push	hl
	call	_vdp_load_palette
	pop	af
00112$:
;demo.c:1678: if (credittimer >= 300 && credittimer < 700 && flipo < 211) {
	ld	a,(#_credittimer+0)
	sub	a,#0x2C
	ld	a,(#_credittimer+1)
	sbc	a,#0x01
	...
	sbc	a,#0x00
	jp	P,00114$
;demo.c:1679: cmd.size_x = 64;
	ld	hl, #_cmd + 8
	ld	(hl),#0x40
	inc	hl
	ld	(hl),#0x00
;demo.c:1680: cmd.size_y = 1;
	ld	hl, #_cmd + 10
	ld	(hl),#0x01
	inc	hl
	ld	(hl),#0x00
;demo.c:1681: cmd.data = 0;
;demo.c:1682: cmd.argument = 0x00; // from 70xY to left
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1683: cmd.command = 0x93; // vram to vram, y only
	ld	a,#0x93
	ld	(#_cmd + 14),a
;demo.c:1684: cmd.source_x = 0;
	...
	inc	hl
	ld	(hl),#0x00
;demo.c:1685: cmd.source_y = 211-flipo;
	ld	bc,#_cmd + 2
	ld	hl,#_flipo
	ld	a,#0xD3
	sub	a,(hl)
...
;demo.c:1690: flipo+=2;
	...
	ld	(hl),a
00114$:
;demo.c:1693: if (credittimer > 700) {
	ld	a,#0xBC
	ld	iy,#_credittimer
	sub	a,0 (iy)
	ld	a,#0x02
	...
	sbc	a,1 (iy)
	jp	P,00118$
;demo.c:1694: msx2_palette(0,PLY_PSGReg10,PLY_PSGReg10,PLY_PSGReg10);
	ld	hl,#_PLY_PSGReg10 + 0
	ld	c,(hl)
	ld	hl,#_PLY_PSGReg10 + 0
	ld	b,(hl)
	...
	pop	af
	pop	af
;demo.c:1696: cmd.size_x = 256;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1697: cmd.size_y = 1;
	ld	hl, #_cmd + 10
	ld	(hl),#0x01
	inc	hl
	ld	(hl),#0x00
;demo.c:1698: cmd.data = 0;
	ld	bc,#_cmd + 12
	ld	a,#0x00
	ld	(bc),a
;demo.c:1699: cmd.argument = 0x00; // from 70xY to left
	ld	hl,#_cmd + 13
	ld	-4 (ix),l
	ld	-3 (ix),h
	ld	(hl),#0x00
;demo.c:1700: cmd.command = 0xd0; // vram to vram, y only
	ld	hl,#_cmd + 14
	ld	-6 (ix),l
	ld	-5 (ix),h
	ld	(hl),#0xD0
;demo.c:1701: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1702: cmd.dest_x = 0;
	ld	de,#_cmd + 4
	ex	de,hl
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1703: cmd.argument = 0x0;
	ld	l,-4 (ix)
	ld	h,-3 (ix)
	ld	(hl),#0x00
;demo.c:1705: cmd.data = 1+((pointframe>>2) & 0xe);
	ld	hl,#_pointframe + 0
	ld	e,(hl)
	ld	hl,#_pointframe + 1
	ld	d,(hl)
	...
	inc	a
	ld	(bc),a
;demo.c:1706: cmd.command = 0x53;
	ld	l,-6 (ix)
	ld	h,-5 (ix)
	ld	(hl),#0x53
;demo.c:1707: for (x = 0; x < 212; x+=1) {
	ld	-2 (ix),#0x00
	ld	-1 (ix),#0x00
00120$:
	ld	a,-2 (ix)
	...
	sbc	a,#0x00
	jp	P,00123$
;demo.c:1708: y = 64+(sintabx[(x+pointframe) & 255]>>1);
	ld	hl,#_pointframe
	ld	a,-2 (ix)
	add	a,(hl)
	ld	e,a
	...
	add	a,#0x40
	ld	c,a
;demo.c:1709: cmd.dest_x = myoffs+y;
	ld	de,#_cmd + 4
	ld	b,#0x00
	ld	a,(#_myoffs+0)
	add	a,c
	...
	inc	hl
	ld	(hl),b
;demo.c:1710: cmd.dest_y = curpage+x;
	ld	bc,#_cmd + 6
	ld	a,(#_curpage+0)
	add	a,-2 (ix)
	ld	e,a
...
;demo.c:1713: pointframe+=2;
	...
	jr	00124$
00118$:
;demo.c:1716: msx2_palette(0,0,0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x00
	push	hl
...
;demo.c:1726: waitVB();
		halt 
;demo.c:1727: uninstall_isr();
	call	_uninstall_isr
;demo.c:1728: PLY_Stop();
	call	_PLY_Stop
;demo.c:1729: PLY_SendRegisters();
	call	_PLY_SendRegisters
;demo.c:1731: screen(0);
	ld	a,#0x00
	push	af
	inc	sp
	call	_screen
	inc	sp
;demo.c:1732: vdp_load_palette(twister_palette);
	ld	hl,#_twister_palette
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1734: puts("bye friends.\r\n\r\n");
	ld	hl,#__str_29
	push	hl
	call	_puts
	pop	af
...
_main:
	...
	add	hl,sp
	ld	sp,hl
;demo.c:1743: unsigned char quit=0;
	ld	-1 (ix),#0x00
;demo.c:1749: spindown();
	call	_spindown
;demo.c:1751: puts("[starting DSS MSX demosystem]\r\n\r\n");
	ld	hl,#__str_30
	push	hl
	call	_puts
	pop	af
;demo.c:1753: for (y = 0; y < 2; y++) {
	ld	-5 (ix),#0x00
	ld	-4 (ix),#0x00
00118$:
	ld	a,-5 (ix)
...
00114$:
	...
	sbc	a,#0x00
	jp	P,00120$
;demo.c:1755: tri_lookup_x[(y*16)+x] = x * 16;
	ld	a,-5 (ix)
	rlca
	rlca
	rlca
	...
	and	a,#0xF0
	ld	(bc),a
;demo.c:1756: tri_lookup_y[(y*16)+x] = (768+129)+(y * 16);
	sla	e
	ld	a,#<_tri_lookup_y
	add	a,e
	ld	l,a
...
00122$:
	...
	sbc	a,#0x00
	jp	P,00125$
;demo.c:1761: twelvetimes[x] = x * 12;
	ld	c,-3 (ix)
	ld	b,-2 (ix)
	sla	c
	rl	b
...
00152$:
	jp	00122$
00125$:
;demo.c:1765: puts("init sweet PSG bleeps...");
	ld	hl,#__str_31
	push	hl
	call	_puts
	pop	af
;demo.c:1767: PLY_SongPtr = (char *)0x0103;
	ld	hl,#_PLY_SongPtr + 0
	ld	(hl), #0x03
	ld	hl,#_PLY_SongPtr + 1
	ld	(hl), #0x01
;demo.c:1768: PLY_Init();
	call	_PLY_Init
;demo.c:1769: puts("done.\r\n");
	ld	hl,#__str_32
	push	hl
	call	_puts
	pop	af
;demo.c:1771: puts("detecting ya vdp type...\r\n");
	ld	hl,#__str_33
	push	hl
	call	_puts
	pop	af
;demo.c:1772: if(isvdp2())
	call	_isvdp2
	xor	a,a
	or	a,l
	jr	Z,00102$
;demo.c:1774: puts("vdp2 found! setting 50hz...\r\n");
	ld	hl,#__str_34
	push	hl
	call	_puts
	pop	af
...
;demo.c:1778: do_quit();
	call	_do_quit
00103$:
;demo.c:1781: memcpy(cur_palette, twister_pl5+7, 32);
	...
	pop	af
	pop	af
;demo.c:1782: memcpy(twister_palette, cur_palette, 32);
	ld	hl,#0x0020
	push	hl
	ld	hl,#_cur_palette
	push	hl
	...
	pop	af
	pop	af
;demo.c:1784: memcpy(cur_palette, boxes_pl5+7, 32);
	ld	bc,#_boxes_pl5 + 7
	ld	hl,#0x0020
	push	hl
	push	bc
	...
	pop	af
	pop	af
;demo.c:1785: memcpy(boxes_palette, cur_palette, 32);
	ld	hl,#0x0020
	push	hl
	ld	hl,#_cur_palette
	push	hl
	...
	pop	af
	pop	af
;demo.c:1787: memcpy(cur_palette, bulbs_pl5+7, 32);
	ld	bc,#_bulbs_pl5 + 7
	ld	hl,#0x0020
	push	hl
	push	bc
	...
	pop	af
	pop	af
;demo.c:1788: memcpy(bulbs_palette, cur_palette, 32);
	ld	hl,#0x0020
	push	hl
	ld	hl,#_cur_palette
	push	hl
	...
	pop	af
	pop	af
;demo.c:1790: memcpy(cur_palette, credit1_pl6+7, 32);
	...
	pop	af
	pop	af
;demo.c:1791: memcpy(credits_palette, cur_palette, 32);
	ld	hl,#0x0020
	push	hl
	ld	hl,#_cur_palette
	push	hl
	...
	pop	af
	pop	af
;demo.c:1794: puts("all good, starting the demo!\r\n");
	ld	hl,#__str_36
	push	hl
	call	_puts
	pop	af
...
;demo.c:1801: pause();
	call	_pause
;demo.c:1803: vdp_set_screen5();
	call	_vdp_set_screen5
;demo.c:1805: scratch_clear();
	call	_scratch_clear
;demo.c:1806: vdp_load_palette(scratch);
	ld	hl,#_scratch
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1808: bitbuster(loading_pck,0x0000,VRAM_0);
	ld	a,#0x01
	push	af
	inc	sp
	ld	hl,#0x0000
...
;demo.c:1819: vdp_copier(&cmd);
	...
	call	_vdp_copier
	pop	af
;demo.c:1821: vdp_register(2,0x7f);
	ld	hl,#0x7F02
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1822: vdp_load_palette(boxes_palette);
	ld	hl,#_boxes_palette
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1826: pck_load("BULBS   PCK",2431,0x0000,VRAM_0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x01
	push	hl
	...
	add	iy,sp
	ld	sp,iy
;demo.c:1828: cmd.size_x = 256;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1829: cmd.size_y = 212;
	ld	hl, #_cmd + 10
	ld	(hl),#0xD4
	inc	hl
	ld	(hl),#0x00
...
;demo.c:1832: cmd.command = 0xd0; 
	...
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1833: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1834: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1835: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
...
;demo.c:1837: vdp_copier(&cmd);
	...
	call	_vdp_copier
	pop	af
;demo.c:1839: pck_load("TWISTER PCK",4032,0x0000,VRAM_0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x01
	push	hl
...
;demo.c:1850: vdp_copier(&cmd);
	...
	call	_vdp_copier
	pop	af
;demo.c:1852: scratch_clear();
	call	_scratch_clear
;demo.c:1853: vdp_load_palette(scratch);
	ld	hl,#_scratch
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:1855: vdp_register(2,0x1f);
	ld	hl,#0x1F02
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1857: pck_load("BOXES   PCK",3002,0x0000,VRAM_0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x01
	push	hl
	...
	add	iy,sp
	ld	sp,iy
;demo.c:1859: cmd.size_x = 256;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1860: cmd.size_y = 212;
	ld	hl, #_cmd + 10
	ld	(hl),#0xD4
	inc	hl
	ld	(hl),#0x00
;demo.c:1861: cmd.data = 0;
;demo.c:1862: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1863: cmd.command = 0xd0; 
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1864: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1865: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1866: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:1867: cmd.dest_y = 768;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x03
;demo.c:1868: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1870: bitbuster(dsslogo_pck,0x0000,VRAM_0);
	ld	a,#0x01
	push	af
	inc	sp
	ld	hl,#0x0000
	...
	pop	af
	inc	sp
;demo.c:1872: cmd.size_x = 108;
	ld	hl, #_cmd + 8
	ld	(hl),#0x6C
	inc	hl
	ld	(hl),#0x00
;demo.c:1873: cmd.size_y = 116;
	ld	hl, #_cmd + 10
	ld	(hl),#0x74
	inc	hl
	ld	(hl),#0x00
...
;demo.c:1876: cmd.command = 0xd0; 
	...
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1877: cmd.source_x = 75;
	ld	hl,#_cmd
	ld	(hl),#0x4B
	inc	hl
	ld	(hl),#0x00
;demo.c:1878: cmd.source_y = 50;
	ld	hl, #_cmd + 2
	ld	(hl),#0x32
	inc	hl
	ld	(hl),#0x00
;demo.c:1879: cmd.dest_x = 75;
	ld	hl, #_cmd + 4
	ld	(hl),#0x4B
	inc	hl
	ld	(hl),#0x00
;demo.c:1880: cmd.dest_y = 256;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:1881: vdp_copier(&cmd);
	...
	call	_vdp_copier
	pop	af
;demo.c:1883: cmd.size_x = 108;
	ld	hl, #_cmd + 8
	ld	(hl),#0x6C
	inc	hl
	ld	(hl),#0x00
;demo.c:1884: cmd.size_y = 60;
	ld	hl, #_cmd + 10
	ld	(hl),#0x3C
	inc	hl
	ld	(hl),#0x00
;demo.c:1885: cmd.data = 0;
;demo.c:1886: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:1887: cmd.command = 0xd0; 
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:1888: cmd.source_x = 75;
	ld	hl,#_cmd
	ld	(hl),#0x4B
	inc	hl
	ld	(hl),#0x00
;demo.c:1889: cmd.source_y = 256+110;
	ld	hl, #_cmd + 2
	ld	(hl),#0x6E
	inc	hl
	ld	(hl),#0x01
;demo.c:1890: cmd.dest_x = 75;
	ld	hl, #_cmd + 4
	ld	(hl),#0x4B
	inc	hl
	ld	(hl),#0x00
;demo.c:1891: cmd.dest_y = 40;
	ld	hl, #_cmd + 6
	ld	(hl),#0x28
	inc	hl
	ld	(hl),#0x00
;demo.c:1892: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1893: cmd.dest_x = 75;
	ld	hl, #_cmd + 4
	ld	(hl),#0x4B
	inc	hl
	ld	(hl),#0x00
;demo.c:1894: cmd.dest_y = 100;
	ld	hl, #_cmd + 6
	ld	(hl),#0x64
	inc	hl
	ld	(hl),#0x00
;demo.c:1895: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
;demo.c:1897: memcpy(cur_palette, dsslogo_pl5+7, 32);
	...
	pop	af
	pop	af
;demo.c:1899: scratch_clear();
	call	_scratch_clear
;demo.c:1901: vdp_register(9,130); // 50hz,212
	ld	hl,#0x8209
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1903: install_isr(my_isr);
	ld	hl,#_my_isr
	push	hl
	call	_install_isr
	pop	af
;demo.c:1907: while (!quit) {
00111$:
	xor	a,a
	or	a,-1 (ix)
	jp	NZ,00113$
;demo.c:1909: if (vbicount >= scenetimings[timeindex+1]) {
	ld	hl,#_timeindex + 0
	ld	c,(hl)
	inc	c
	sla	c
...
;demo.c:1911: timeindex+=2;
	...
	ld	(hl),a
00105$:
;demo.c:1914: if (vbicount >= scenetimings[timeindex] && vbicount < scenetimings[timeindex+1]) {
	ld	hl,#_timeindex + 0
	ld	c,(hl)
	ld	hl,#_timeindex + 1
	ld	b,(hl)
...
;demo.c:1915: waitVB();
		halt 
;demo.c:1916: scenepointers[sceneindex]();
	ld	hl,#_sceneindex + 0
	ld	c,(hl)
	ld	iy,#_sceneindex
	ld	b,1 (iy)
