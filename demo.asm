...
; This file was generated Wed Feb 28 02:00:56 2018
;--------------------------------------------------------
	.module demo
	.optsdcc -mz80
...
;demo.c:750: int buffer = 1;
	...
	ld	iy,#_buffer
	ld	1 (iy),#0x00
;demo.c:751: int dbly = 0;
	ld	iy,#_dbly
	ld	0 (iy),#0x00
	ld	iy,#_dbly
	ld	1 (iy),#0x00
;demo.c:752: int prevx = -1;
	ld	iy,#_prevx
	ld	0 (iy),#0xFF
	ld	iy,#_prevx
	ld	1 (iy),#0xFF
;demo.c:777: int bx = 256-42;
	ld	iy,#_bx
	ld	0 (iy),#0xD6
	ld	iy,#_bx
	ld	1 (iy),#0x00
;demo.c:778: int by = 84;
	ld	iy,#_by
	ld	0 (iy),#0x54
	ld	iy,#_by
	ld	1 (iy),#0x00
;demo.c:779: int bt = 0;
	...
	ld	iy,#_bt
	ld	1 (iy),#0x00
;demo.c:780: int bxx = 0;
	ld	iy,#_bxx
	ld	0 (iy),#0x00
	ld	iy,#_bxx
	ld	1 (iy),#0x00
;demo.c:781: int byy = 0;
	ld	iy,#_byy
	ld	0 (iy),#0x00
	ld	iy,#_byy
	ld	1 (iy),#0x00
...
;demo.c:786: int pbt = 0;
	...
	ld	iy,#_pbt
	ld	1 (iy),#0x00
;demo.c:888: uint8_t tri_inited = 0;
	ld	iy,#_tri_inited
	ld	0 (iy),#0x00
;demo.c:916: char tripal[9] = {
	ld	hl,#_tripal
	call	__initrleblock
	.db	9
	...
	.db	0x02
	.db	0
;demo.c:922: uint8_t tripaltick = 0;
	ld	iy,#_tripaltick
	ld	0 (iy),#0x00
;demo.c:924: int triframes = 0;
	ld	iy,#_triframes
	ld	0 (iy),#0x00
	ld	iy,#_triframes
	ld	1 (iy),#0x00
;demo.c:1029: int sceneindex = 0;
	ld	iy,#_sceneindex
	ld	0 (iy),#0x00
	ld	iy,#_sceneindex
	ld	1 (iy),#0x00
;demo.c:1030: int timeindex = 0;
	ld	iy,#_timeindex
	ld	0 (iy),#0x00
	ld	iy,#_timeindex
	ld	1 (iy),#0x00
;demo.c:1032: void (*scenepointers[6])() = {
	...
	inc	hl
	ld	(hl),#>_animplay
;demo.c:1041: int scenetimings[12] = {
	ld	hl,#_scenetimings
	call	__initrleblock
	.db	24
...
__str_11:
	.ascii "LF3     PCK"
	.db 0x00
;demo.c:757: void drawbox(int box_x, int box_y, uint8_t x, uint8_t y) {
;	---------------------------------
; Function drawbox
; ---------------------------------
_drawbox_start::
...
;demo.c:758: dbly = 0;
	...
	ld	hl,#_dbly + 1
	ld	(hl), #0x00
;demo.c:760: cmd.source_x = box_x * 42;
	ld	e,4 (ix)
	ld	d,5 (ix)
	ld	l,e
	ld	h,d
	...
	inc	hl
	ld	(hl),b
;demo.c:761: cmd.source_y = 768+box_y * 42;
	ld	bc,#_cmd + 2
	ld	e,6 (ix)
	ld	d,7 (ix)
	ld	l,e
...
;demo.c:763: cmd.dest_y = dbly+y;
	...
	inc	hl
	ld	(hl),d
;demo.c:764: cmd.size_x = 42;
	ld	hl, #_cmd + 8
	ld	(hl),#0x2A
	inc	hl
	ld	(hl),#0x00
;demo.c:765: cmd.size_y = 42;
	ld	hl, #_cmd + 10
	ld	(hl),#0x2A
	inc	hl
	ld	(hl),#0x00
...
;demo.c:797: cmd.dest_y = pbt;
	...
	inc	hl
	ld	(hl),d
;demo.c:798: cmd.size_x = 42;
	ld	hl, #_cmd + 8
	ld	(hl),#0x2A
	inc	hl
	ld	(hl),#0x00
;demo.c:799: cmd.size_y = 42;
	ld	hl, #_cmd + 10
	ld	(hl),#0x2A
	inc	hl
	ld	(hl),#0x00
...
;demo.c:803: vdp_copier(&cmd);
	...
	pop	af
00102$:
;demo.c:807: if (boxes_init == 0) {
	xor	a,a
	ld	hl,#_boxes_init + 0
	or	a,(hl)
	jp	NZ,00104$
;demo.c:808: boxes_init = 1;
	ld	iy,#_boxes_init
	ld	0 (iy),#0x01
;demo.c:810: cmd.size_x = 8;
	ld	hl, #_cmd + 8
	ld	(hl),#0x08
	inc	hl
	ld	(hl),#0x00
;demo.c:811: cmd.size_y = 212;
	ld	hl, #_cmd + 10
	ld	(hl),#0xD4
	inc	hl
	ld	(hl),#0x00
;demo.c:812: cmd.data = 0;
;demo.c:813: cmd.argument = 0x00; // from 70xY to left
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:814: cmd.command = 0xd0; // vram to vram, y only
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:815: cmd.source_x = 248;
	ld	hl,#_cmd
	ld	(hl),#0xF8
	inc	hl
	ld	(hl),#0x00
;demo.c:816: cmd.source_y = 0;
	ld	hl, #_cmd + 2
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:817: cmd.dest_y = 0;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:819: for (x = 248; x >= 0; x-=8) {
	ld	bc,#0x00F8
00131$:
	ld	a,b
	bit	7,a
...
;demo.c:819: for (x = 248; x >= 0; x-=8) {
	...
	jr	00131$
00134$:
;demo.c:828: drawsine("LET US STOP   WE ARE BUILDING WALLS BETWEEN",8,180);
	ld	hl,#0xB408
	push	hl
	ld	hl,#__str_12
	push	hl
	...
	pop	af
	pop	af
;demo.c:830: vdp_load_palette(boxes_palette);
	ld	hl,#_boxes_palette
	push	hl
	call	_vdp_load_palette
	pop	af
00104$:
;demo.c:833: if (bt >= 80) bt+=6;
	ld	a,(#_bt+0)
	sub	a,#0x50
	ld	a,(#_bt+1)
	sbc	a,#0x00
	...
	ld	(hl),a
00106$:
;demo.c:834: if (bt < 80 && bt >= 60) bt+=5;
	ld	a,(#_bt+0)
	sub	a,#0x50
	ld	a,(#_bt+1)
	sbc	a,#0x00
	...
	ld	(hl),a
00108$:
;demo.c:835: if (bt < 60 && bt >= 40) bt+=4;
	ld	a,(#_bt+0)
	sub	a,#0x3C
	ld	a,(#_bt+1)
	sbc	a,#0x00
	...
	ld	(hl),a
00111$:
;demo.c:836: if (bt < 40 && bt >= 10) bt+=3;
	ld	a,(#_bt+0)
	sub	a,#0x28
	ld	a,(#_bt+1)
	sbc	a,#0x00
...
;demo.c:837: if (bt < 10 ) bt+=2;
	...
	ld	(hl),a
00117$:
;demo.c:841: cmd.source_x = bx;
	ld	bc,(_bx)
	ld	hl,#_cmd
	ld	(hl),c
	inc	hl
	ld	(hl),b
;demo.c:842: cmd.source_y = bt;
	ld	bc,#_cmd + 2
	ld	de,(_bt)
	ld	l,c
	ld	h,b
	...
	inc	hl
	ld	(hl),d
;demo.c:843: cmd.dest_x = 0;
	ld	hl, #_cmd + 4
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:844: cmd.dest_y = 256;
	ld	hl, #_cmd + 6
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:845: cmd.size_x = 42;
	ld	hl, #_cmd + 8
	ld	(hl),#0x2A
	inc	hl
	ld	(hl),#0x00
;demo.c:846: cmd.size_y = 42;
	ld	hl, #_cmd + 10
	ld	(hl),#0x2A
	inc	hl
	ld	(hl),#0x00
;demo.c:847: cmd.data = 0;
;demo.c:848: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:849: cmd.command = 0xD0; // HMMM
	ld	a,#0xD0
	ld	(#_cmd + 14),a
;demo.c:850: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
...
;demo.c:855: waitVB();
		halt 
;demo.c:857: drawbox(bxx,byy,bx,bt);
	ld	hl,#_bt + 0
	ld	c,(hl)
	ld	hl,#_bx + 0
	ld	b,(hl)
...
__str_12:
	...
	.db 0x00
;demo.c:890: void drawtritile(uint8_t tx, int ty, uint8_t x, uint8_t y) {
;	---------------------------------
...
;demo.c:894: cmd.dest_y = y;
	...
	inc	hl
	ld	(hl),d
;demo.c:895: cmd.size_x = 16;
	ld	hl, #_cmd + 8
	ld	(hl),#0x10
	inc	hl
	ld	(hl),#0x00
;demo.c:896: cmd.size_y = 16;
	ld	hl, #_cmd + 10
	ld	(hl),#0x10
	inc	hl
	ld	(hl),#0x00
;demo.c:897: cmd.data = 0;
;demo.c:898: cmd.argument = 0x00;
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:899: cmd.command = 0xd0; // HMMM
	ld	a,#0xD0
	ld	(#_cmd + 14),a
;demo.c:900: vdp_copier(&cmd);
	ld	hl,#_cmd
	push	hl
	call	_vdp_copier
	pop	af
	...
	ret
_drawtritile_end::
;demo.c:903: void drawtilescreen(char* tripic) {
;	---------------------------------
...
00103$:
	...
	sbc	a,#0x00
	jp	P,00106$
;demo.c:908: drawtritile(tri_lookup_x[tripic[i]],tri_lookup_y[tripic[i]],x,y);
	ld	a,-4 (ix)
	ld	-8 (ix),a
	ld	a,-2 (ix)
	ld	-7 (ix),a
...
_tritiles:
	...
	add	hl,sp
	ld	sp,hl
;demo.c:933: if (tri_inited == 0) {
	xor	a,a
	ld	hl,#_tri_inited + 0
	or	a,(hl)
	jp	NZ,00102$
;demo.c:934: tri_inited = 1;
	ld	iy,#_tri_inited
	ld	0 (iy),#0x01
;demo.c:936: cmd.size_x = 256;
	ld	hl, #_cmd + 8
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x01
;demo.c:937: cmd.size_y = 1;
	ld	hl, #_cmd + 10
	ld	(hl),#0x01
	inc	hl
	ld	(hl),#0x00
;demo.c:938: cmd.data = 0;
;demo.c:939: cmd.argument = 0x00; // from 70xY to left
	ld	a,#0x00
	ld	(#_cmd + 12),a
	ld	(#_cmd + 13),a
;demo.c:940: cmd.command = 0xd0; // vram to vram, y only
	ld	bc,#_cmd + 14
	ld	a,#0xD0
	ld	(bc),a
;demo.c:941: cmd.source_x = 0;
	ld	hl,#_cmd
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:942: cmd.source_y = 255;
	ld	hl, #_cmd + 2
	ld	(hl),#0xFF
	inc	hl
	ld	(hl),#0x00
;demo.c:943: cmd.dest_y = 0;
	ld	bc,#_cmd + 6
	ld	l,c
	ld	h,b
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:945: for (x = 0; x < 212; x++) {
	ld	-2 (ix),#0xD4
	ld	-1 (ix),#0x00
00121$:
;demo.c:946: waitVB();
		halt 
;demo.c:947: cmd.dest_x = 0;
	ld	de,#_cmd + 4
	ex	de,hl
	ld	(hl),#0x00
	inc	hl
	ld	(hl),#0x00
;demo.c:948: cmd.dest_y = x;
	ld	de,#_cmd + 6
	ld	c,-2 (ix)
	ld	b,-1 (ix)
	dec	bc
...
;demo.c:945: for (x = 0; x < 212; x++) {
	...
	or	a,-1 (ix)
	jr	NZ,00121$
;demo.c:952: vdp_register(9,2); // 50hz,192
	ld	hl,#0x0209
	push	hl
	call	_vdp_register
	pop	af
;demo.c:954: vdp_load_palette(boxes_palette);
	ld	hl,#_boxes_palette
	push	hl
	call	_vdp_load_palette
	pop	af
;demo.c:956: msx2_palette(15,0,0,0);
	ld	hl,#0x0000
	push	hl
	ld	l, #0x0F
	push	hl
	...
	pop	af
	pop	af
;demo.c:958: drawtilescreen(tri_center);
	ld	hl,#_tri_center
	push	hl
	call	_drawtilescreen
	pop	af
00102$:
;demo.c:963: triframes++;
	ld	iy,#_triframes
	inc	0 (iy)
	jr	NZ,00142$
	ld	iy,#_triframes
...
00143$:
	jr	00104$
00144$:
;demo.c:965: drawtilescreen(tri_up);
	ld	hl,#_tri_up
	push	hl
	call	_drawtilescreen
	pop	af
00104$:
;demo.c:968: if (triframes == 400) {
	ld	a,(#_triframes+0)
	sub	a,#0x90
	jr	NZ,00145$
	ld	a,(#_triframes+1)
...
00145$:
	jr	00106$
00146$:
;demo.c:969: drawtilescreen(tri_dia);
	ld	hl,#_tri_dia
	push	hl
	call	_drawtilescreen
	pop	af
00106$:
;demo.c:971: if (triframes == 600) {
	ld	a,(#_triframes+0)
	sub	a,#0x58
	jr	NZ,00147$
	ld	a,(#_triframes+1)
...
00147$:
	jr	00108$
00148$:
;demo.c:972: drawtilescreen(tri_side1);
	ld	hl,#_tri_side1
	push	hl
	call	_drawtilescreen
	pop	af
00108$:
;demo.c:974: if (triframes == 700) {
	ld	a,(#_triframes+0)
	sub	a,#0xBC
	jr	NZ,00149$
	ld	a,(#_triframes+1)
...
00149$:
	jr	00110$
00150$:
;demo.c:975: drawtilescreen(tri_side2);
	ld	hl,#_tri_side2
	push	hl
	call	_drawtilescreen
	pop	af
00110$:
;demo.c:977: if (triframes == 800) {
	ld	a,(#_triframes+0)
	sub	a,#0x20
	jr	NZ,00151$
	ld	a,(#_triframes+1)
...
00151$:
	jr	00112$
00152$:
;demo.c:978: drawtilescreen(tri_side1);
	ld	hl,#_tri_side1
	push	hl
	call	_drawtilescreen
	pop	af
00112$:
;demo.c:980: if (triframes == 900) {
	ld	a,(#_triframes+0)
	sub	a,#0x84
	jr	NZ,00153$
	ld	a,(#_triframes+1)
...
00153$:
	jr	00114$
00154$:
;demo.c:981: drawtilescreen(tri_side2);
	ld	hl,#_tri_side2
	push	hl
	call	_drawtilescreen
	pop	af
00114$:
;demo.c:983: if (triframes == 1000) {
	ld	a,(#_triframes+0)
	sub	a,#0xE8
	jr	NZ,00155$
	ld	a,(#_triframes+1)
...
00155$:
	jr	00116$
00156$:
;demo.c:984: triframes = 0;
	ld	hl,#_triframes + 0
	ld	(hl), #0x00
	ld	hl,#_triframes + 1
	ld	(hl), #0x00
;demo.c:985: drawtilescreen(tri_center);
	ld	hl,#_tri_center
	push	hl
	call	_drawtilescreen
	pop	af
00116$:
;demo.c:988: msx2_palette(3,tripal[0],tripal[1],tripal[2]);
	ld	hl,#_tripal + 2
	ld	c,(hl)
	ld	de,#_tripal + 1
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:989: msx2_palette(13,tripal[3],tripal[4],tripal[5]);
	ld	hl,#_tripal + 5
	ld	c,(hl)
	ld	de,#_tripal + 4
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:990: msx2_palette(5,tripal[6],tripal[7],tripal[8]);
	ld	hl,#_tripal + 8
	ld	c,(hl)
	ld	de,#_tripal + 7
	ld	a,(de)
	...
	pop	af
	pop	af
;demo.c:993: tripaltick++;
	ld	iy,#_tripaltick
	inc	0 (iy)
;demo.c:994: if (tripaltick > 6) {
	ld	a,#0x06
	ld	iy,#_tripaltick
	sub	a,0 (iy)
	jp	NC,00126$
;demo.c:996: r = tripal[0];
	ld	hl,#_tripal
	ld	c,(hl)
	ld	-3 (ix),c
;demo.c:997: g = tripal[1];
	ld	de,#_tripal + 1
	ld	a,(de)
	ld	-4 (ix),a
;demo.c:998: b = tripal[2];
	ld	hl,#_tripal + 2
	ld	e,(hl)
	ld	-5 (ix),e
;demo.c:1000: for (x = 0; x < 6; x++) {
	ld	-2 (ix),#0x00
	ld	-1 (ix),#0x00
00122$:
	ld	a,-2 (ix)
	...
	sbc	a,#0x00
	jp	P,00125$
;demo.c:1001: tripal[x] = tripal[x+3];
	ld	a,#<_tripal
	add	a,-2 (ix)
	ld	c,a
	ld	a,#>_tripal
...
00157$:
	jr	00122$
00125$:
;demo.c:1004: tripal[6] = r;
	ld	bc,#_tripal + 6
	ld	a,-3 (ix)
	ld	(bc),a
;demo.c:1005: tripal[7] = g;
	ld	bc,#_tripal + 7
	ld	a,-4 (ix)
	ld	(bc),a
;demo.c:1006: tripal[8] = b;
	ld	bc,#_tripal + 8
	ld	a,-5 (ix)
	ld	(bc),a
;demo.c:1007: tripaltick = 0;
	ld	hl,#_tripaltick + 0
	ld	(hl), #0x00
00126$:
	ld	sp,ix
...
;demo.c:1017: waitVB();
		halt 
;demo.c:1018: uninstall_isr();
	call	_uninstall_isr
;demo.c:1019: PLY_Stop();
	call	_PLY_Stop
;demo.c:1020: PLY_SendRegisters();
	call	_PLY_SendRegisters
;demo.c:1022: screen(0);
	ld	a,#0x00
	push	af
	inc	sp
	call	_screen
	inc	sp
;demo.c:1024: puts("demo quit\r\n\r\n");
	ld	hl,#__str_13
	push	hl
	call	_puts
	pop	af
...
_main:
	...
	add	hl,sp
	ld	sp,hl
;demo.c:1051: unsigned char quit=0;
	ld	-1 (ix),#0x00
;demo.c:1057: spindown();
	call	_spindown
;demo.c:1059: puts("demo init\r\n\r\n");
	ld	hl,#__str_14
	push	hl
	call	_puts
	pop	af
;demo.c:1061: for (y = 0; y < 2; y++) {
	ld	-5 (ix),#0x00
	ld	-4 (ix),#0x00
00118$:
	ld	a,-5 (ix)
...
00114$:
	...
	sbc	a,#0x00
	jp	P,00120$
;demo.c:1063: tri_lookup_x[(y*16)+x] = x * 16;
	ld	a,-5 (ix)
	rlca
	rlca
	rlca
	...
	and	a,#0xF0
	ld	(bc),a
;demo.c:1064: tri_lookup_y[(y*16)+x] = (768+129)+(y * 16);
	sla	e
	ld	a,#<_tri_lookup_y
	add	a,e
	ld	l,a
...
00140$:
	jp	00118$
00121$:
;demo.c:1068: puts("music init...");
	ld	hl,#__str_15
	push	hl
	call	_puts
	pop	af
;demo.c:1070: PLY_SongPtr = (char *)0x0103;
	ld	hl,#_PLY_SongPtr + 0
	ld	(hl), #0x03
	ld	hl,#_PLY_SongPtr + 1
	ld	(hl), #0x01
;demo.c:1071: PLY_Init();
	call	_PLY_Init
;demo.c:1072: puts("done.\r\n");
	ld	hl,#__str_16
	push	hl
	call	_puts
	pop	af
;demo.c:1074: puts("detecting vdp type...\r\n\r\n");
	ld	hl,#__str_17
	push	hl
	call	_puts
	pop	af
;demo.c:1075: if(isvdp2())
	call	_isvdp2
	xor	a,a
	or	a,l
	jr	Z,00102$
;demo.c:1077: puts("vdp2 found! setting 50hz...\r\n\r\n");
	ld	hl,#__str_18
	push	hl
	call	_puts
	pop	af
...
;demo.c:1081: do_quit();
	call	_do_quit
00103$:
;demo.c:1084: pal_load("TWISTER PL5",32,1);
	ld	hl,#0x0001
	push	hl
	ld	a,#0x20
	push	af
	...
	pop	af
	inc	sp
;demo.c:1085: memcpy(twister_palette, cur_palette, 32);
	ld	hl,#0x0020
	push	hl
	ld	hl,#_cur_palette
	push	hl
	...
	pop	af
	pop	af
;demo.c:1086: pal_load("LF      PL5",32,1);
	ld	hl,#0x0001
	push	hl
	ld	a,#0x20
	push	af
	...
	pop	af
	inc	sp
;demo.c:1087: memcpy(tf_palette, cur_palette, 32);
	ld	hl,#0x0020
	push	hl
	ld	hl,#_cur_palette
	push	hl
	...
	pop	af
	pop	af
;demo.c:1088: pal_load("BOXES   PL5",32,1);
	ld	hl,#0x0001
	push	hl
	ld	a,#0x20
	push	af
	...
	pop	af
	inc	sp
;demo.c:1089: memcpy(boxes_palette, cur_palette, 32);
	ld	hl,#0x0020
	push	hl
	ld	hl,#_cur_palette
	push	hl
	...
	pop	af
	pop	af
;demo.c:1090: pal_load("BULBS   PL5",32,1);
	ld	hl,#0x0001
	push	hl
	ld	a,#0x20
	push	af
...
;demo.c:1143: scratch_clear();
	call	_scratch_clear
;demo.c:1145: vdp_register(9,130); // 50hz,212
	ld	hl,#0x8209
	push	hl
	call	_vdp_register
	pop	af
;demo.c:1147: install_isr(my_isr);
	ld	hl,#_my_isr
	push	hl
	call	_install_isr
	pop	af
;demo.c:1149: while (!quit) {
00111$:
	xor	a,a
	or	a,-1 (ix)
	jp	NZ,00113$
;demo.c:1151: if (vbicount >= scenetimings[timeindex+1]) {
	ld	hl,#_timeindex + 0
	ld	c,(hl)
	inc	c
	sla	c
...
;demo.c:1153: timeindex+=2;
	...
	ld	(hl),a
00105$:
;demo.c:1156: if (vbicount >= scenetimings[timeindex] && vbicount < scenetimings[timeindex+1]) {
	ld	hl,#_timeindex + 0
	ld	c,(hl)
	ld	hl,#_timeindex + 1
	ld	b,(hl)
...
;demo.c:1157: waitVB();
		halt 
;demo.c:1158: scenepointers[sceneindex]();
	ld	hl,#_sceneindex + 0
	ld	c,(hl)
	ld	iy,#_sceneindex
	ld	b,1 (iy)
