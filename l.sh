...
if [ -f demo.ihx ]; then
	...
	wrdsk demo.dsk demo.com monolog.pck monolog.pi6 lf.pl5 lf1.pck lf2.pck lf3.pck kettu11.pck kettu12.pck kettu16.pck kettu16.pl5 twister.pck twister.pl5 sample.raw stdblck.pck stdblck.pl5 msxdos2.sys command2.com autoexec.bat
