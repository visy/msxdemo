...
sdcc -mz80 --code-loc 0x0178 --data-loc 0 --no-std-crt0 --opt-code-size --out-fmt-ihx crt0msx_msxdos_advanced.rel putchar.rel getchar.rel dos.rel vdp.rel conio.rel demo.c
