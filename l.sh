...
sdcc -mz80 -L. --code-loc 0x$CODELOC --data-loc 0 --no-std-crt0 --out-fmt-ihx crt0msx_msxdos_biisi.o pletter.o putchar.o getchar.o dos.o vdp.o arkos.o conio.o mem.o heap.o interrupt.o msxlib.o demo.c

if [ -f demo.ihx ]; then
	hex2bin demo.ihx
	mv demo.bin demo.com
	wrdsk demo.dsk demo.com monolog.pck monolog.pl6 kettu11.pck kettu12.pck kettu16.pl5 msxdos2.sys command2.com autoexec.bat
